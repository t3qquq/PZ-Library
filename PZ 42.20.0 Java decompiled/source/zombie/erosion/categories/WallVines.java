...
public final class WallVines extends ErosionCategory {
            ...
            if (obj.attachedAnimSprite != null) {
                for (int j = 0; j < obj.attachedAnimSprite.size(); j++) {
                    ...
                    if (spr != null && spr.getName() != null && spr.getName().startsWith("f_wallvines_1_") && this.spriteToObj.containsKey(spr.getName())) {
                        WallVines.CategoryData sqCategoryData = (WallVines.CategoryData)this.setCatModData(sqErosionData);
    ...
    public void update(IsoGridSquare square, ErosionData.Square sqErosionData, ErosionCategory.Data data, ErosionData.Chunk chunkData, int eTick) {
        WallVines.CategoryData sqCategoryData = (WallVines.CategoryData)data;
