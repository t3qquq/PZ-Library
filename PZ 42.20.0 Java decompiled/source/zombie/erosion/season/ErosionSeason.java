...
public final class ErosionSeason {
    ...
    public void setDay(int day, int month, int year) {
        ...
        this.setSeasonData((float)dayValue, dayDate, year, month);
    ...
    private void setSeasonData(float dayValue, GregorianCalendar dayDate, int year, int month) {
        ...
        float rainMod = 0.1F + this.rain[month] <= 1.0F ? 0.1F + this.rain[month] : 1.0F;
    ...
    private void setDaylightData(long dayValue, GregorianCalendar dayDate) {
        ...
        float hCyclePerc = this.dayDiff(dayDate, cycleStart) / this.dayDiff(cycleStart, cycleEnd);
