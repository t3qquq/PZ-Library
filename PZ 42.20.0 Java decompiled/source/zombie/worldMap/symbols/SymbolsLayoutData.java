...
public final class SymbolsLayoutData {
    static final ObjectPool<SymbolLayout> s_layoutPool = new ObjectPool<>(SymbolLayout::new, "SymbolsLayoutData.s_layoutPool");
    ...
    void initMainThread(WorldMapBaseSymbol originalSymbol, WorldMapBaseSymbol symbolCopy, SymbolsLayoutData originalLayoutData, WorldMapStyle styleCopy) {
        ...
        layoutCopy.isAuthorHidden = originalSymbol.isShared() && WorldMapClient.getInstance().isAuthorHidden(originalSymbol.getNetworkInfo().getAuthor());
