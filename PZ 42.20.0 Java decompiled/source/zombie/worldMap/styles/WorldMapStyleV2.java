...
public class WorldMapStyleV2 extends WorldMapStyleV1 {
    ...
    private static final class Listener extends IWorldMapStyleListener {
        ...
        void onAdd(WorldMapStyleLayer origLayer) {
            if (origLayer instanceof WorldMapLineStyleLayer layer) {
                WorldMapStyleV1.WorldMapLineStyleLayerV1 layerV1 = new WorldMapStyleV1.WorldMapLineStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
            } else if (origLayer instanceof WorldMapPolygonStyleLayer layer) {
                WorldMapStyleV1.WorldMapPolygonStyleLayerV1 layerV1 = new WorldMapStyleV1.WorldMapPolygonStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
            } else if (origLayer instanceof WorldMapTextStyleLayer layer) {
                WorldMapStyleV2.WorldMapTextStyleLayerV1 layerV1 = new WorldMapStyleV2.WorldMapTextStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
            } else if (origLayer instanceof WorldMapTextureStyleLayer layer) {
                WorldMapStyleV1.WorldMapTextureStyleLayerV1 layerV1 = new WorldMapStyleV1.WorldMapTextureStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
            } else {
                if (origLayer instanceof WorldMapPyramidStyleLayer layer) {
                    WorldMapStyleV2.WorldMapPyramidStyleLayerV1 layerV1 = new WorldMapStyleV2.WorldMapPyramidStyleLayerV1(this.api, layer);
                    this.api.layers.add(this.api.style.indexOf(layer), layerV1);
                }
            }
        }
