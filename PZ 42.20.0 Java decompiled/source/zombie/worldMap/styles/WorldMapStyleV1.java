...
public class WorldMapStyleV1 {
    ...
    protected static final class Listener extends IWorldMapStyleListener {
        ...
        void onAdd(WorldMapStyleLayer origLayer) {
            if (origLayer instanceof WorldMapLineStyleLayer layer) {
                ...
                WorldMapStyleV1.WorldMapStyleLayerV1 layerV1 = new WorldMapStyleV1.WorldMapStyleLayerV1(this.api, origLayer);
                this.api.layers.add(this.api.style.indexOf(origLayer), layerV1);
            }
        }
    ...
    public static class WorldMapPolygonStyleLayerV1 extends WorldMapStyleV1.WorldMapStyleLayerV1 {
        ...
        public void setScaleValue(int index, int scale) {
            this.polygonStyle.scale.get(index).f = PZMath.clamp(scale, 0.0F, Float.MAX_VALUE);
        }
