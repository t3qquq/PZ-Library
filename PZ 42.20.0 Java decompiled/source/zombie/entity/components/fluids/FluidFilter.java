...
public class FluidFilter {
    ...
    public void setFilterScript(String filterScriptName) {
        if (filterScriptName == null) {
            ...
            if (script == null) {
                DebugType.General.warn("FluidFilter '" + filterScriptName + "' not found.");
            }
    ...
    public String getFilterDisplayName() {
        ...
        for (String fluid : this.fluidStrings) {
            String name = Fluid.Get(fluid).getDisplayName();
    ...
    public void load(ByteBuffer input, int worldVersion) throws IOException {
        ...
        this.filterType = input.get() != 0 ? FluidFilter.FilterType.Whitelist : FluidFilter.FilterType.Blacklist;
        int count = input.get();
        if (count > 0) {
