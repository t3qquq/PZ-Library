...
public class Fluid {
    ...
    public static final Fluid Alcohol = addFluid(FluidType.RubbingAlcohol);
    ...
    public static void Init(ScriptLoadMode loadMode) throws Exception {
        ...
        for (FluidDefinitionScript script : scripts) {
            if (script.getFluidType() == FluidType.Modded) {
                DebugType.Fluid.println(script.getModID() + " = " + script.getFluidTypeString());
                ...
                DebugType.Fluid.println(script.getModID() + " = " + script.getFluidType());
        ...
        for (FluidDefinitionScript script : scripts) {
            Fluid fluid = scriptToFluidMap.get(script);
            if (fluid != null) {
                if (script.getBlendWhitelist() != null) {
                    fluid.blendWhitelist = script.getBlendWhitelist().createFilter();
                ...
                if (script.getBlendBlackList() != null) {
                    fluid.blendBlacklist = script.getBlendBlackList().createFilter();
