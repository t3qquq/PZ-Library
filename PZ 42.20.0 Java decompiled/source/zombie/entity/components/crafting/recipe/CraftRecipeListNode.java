...
public class CraftRecipeListNode {
    ...
    public static CraftRecipeListNode createRecipeNode(CraftRecipe recipe, CraftRecipeListNode parent) {
        ...
        if (recipe != null) {
            ...
            DebugType.CraftLogic.error("recipe == null when calling CraftRecipeListNode:allocRecipe - This should not happen!");
        }
    ...
    @UsedFromLua
    public enum CraftRecipeListNodeExpandedState {
        CLOSED,
        PARTIAL,
        OPEN;
    }
    ...
    @UsedFromLua
    public enum CraftRecipeListNodeType {
        GROUP,
        RECIPE;
    }
}
