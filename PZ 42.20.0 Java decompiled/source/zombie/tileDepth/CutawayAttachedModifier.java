...
public class CutawayAttachedModifier implements Consumer<TextureDraw> {
    ...
    public void accept(TextureDraw textureDraw) {
        ...
        float x3;
        float x0 = x3 = PZMath.max(tex0.offsetX, tex1.offsetX, tex2OffsetX);
        float x2;
        float x1 = x2 = PZMath.min(tex0.offsetX + tex0.getWidth(), tex1.offsetX + tex1.getWidth(), tex2OffsetX + tex2Width);
        float y1;
        float y0 = y1 = PZMath.max(tex0.offsetY, tex1.offsetY, tex2OffsetY);
        float y3;
        float y2 = y3 = PZMath.min(tex0.offsetY + tex0.getHeight(), tex1.offsetY + tex1.getHeight(), tex2OffsetY + tex2Height);
        ...
        textureDraw.tex2U0 = (this.cutawayX + (x0 - tex2OffsetX)) / tex2.getWidthHW();
        textureDraw.tex2U1 = (this.cutawayX + (x1 - tex2OffsetX)) / tex2.getWidthHW();
        textureDraw.tex2U2 = (this.cutawayX + (x2 - tex2OffsetX)) / tex2.getWidthHW();
        textureDraw.tex2U3 = (this.cutawayX + (x3 - tex2OffsetX)) / tex2.getWidthHW();
        textureDraw.tex2V0 = (this.cutawayY + (y0 - tex2OffsetY)) / tex2.getHeightHW();
        textureDraw.tex2V1 = (this.cutawayY + (y1 - tex2OffsetY)) / tex2.getHeightHW();
        textureDraw.tex2V2 = (this.cutawayY + (y2 - tex2OffsetY)) / tex2.getHeightHW();
        textureDraw.tex2V3 = (this.cutawayY + (y3 - tex2OffsetY)) / tex2.getHeightHW();
