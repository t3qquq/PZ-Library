...
public final class TileGeometryUtils {
    ...
    public static UI3DScene.Ray getCameraRay(
        float uiX, float uiY, Matrix4f projection, Matrix4f modelView, int viewWidth, int viewHeight, UI3DScene.Ray cameraRay
    ) {
        ...
        Vector3f rayStart = matrix4f.unprojectInv(uiX, uiY, 0.0F, m_viewport, allocVector3f());
        Vector3f rayEnd = matrix4f.unprojectInv(uiX, uiY, 1.0F, m_viewport, allocVector3f());
