...
public class Clothing extends InventoryItem {
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
        ...
        if (this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK)) {
            if (this.hasFilter()) {
    ...
    public String getName(IsoPlayer player) {
        String prefix = "";
        if (this.isDirty()) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Dirty") + ", ";
        }
        ...
        if (this.getWetness() >= 100.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Soaked") + ", ";
        } else if (this.getWetness() > 25.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Wet") + ", ";
        }

        if (this.isBroken()) {
            prefix = prefix + Translator.getText("Tooltip_Clothing_broken") + ", ";
        } else if (this.getCondition() < this.getConditionMax() / 3.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Worn") + ", ";
        }
    ...
    public boolean hasFilter() {
        return this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK)
    ...
    public void setNoFilter() {
        if (this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK)) {
            ...
            if (this.is(ItemKey.Clothing.HAT_IMPROVISED_GAS_MASK)) {
    ...
    public void setNoTank() {
        if (this.hasTag(ItemTag.SCBA)) {
            ...
            if (this.is(ItemKey.Clothing.SCBA)) {
    ...
    public void drainGasMask(float rate) {
        if (this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK) && this.hasFilter() && !(this.getUsedDelta() <= 0.0F)) {
