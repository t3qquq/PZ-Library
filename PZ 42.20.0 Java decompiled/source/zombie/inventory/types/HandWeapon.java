...
public final class HandWeapon extends InventoryItem implements IUpdater {
    ...
    public boolean checkJam(IsoPlayer player, boolean racking) {
        ...
        DebugType.Combat.debugln("Jam chance: %f, roll: %f, jammed: %s", chance, roll, roll < chance);
        if (roll < chance) {
            this.setJammed(true);
        }
    ...
    public boolean checkUnJam(IsoPlayer player) {
        ...
        float roll = Rand.Next(0.0F, 1.0F);
        DebugType.Combat.debugln("UnJam chance: %f, roll: %f, unjammed: %s", chance, roll, roll < chance);
        if (roll < chance) {
