...
public final class ParameterMeleeHitSurface extends FMODLocalParameter {
    ...
    public static ParameterMeleeHitSurface.Material getMaterialFromString(String material) {
        return !"MetalPoleGateDouble".equalsIgnoreCase(material) && !"MetalPoleGateSmall".equalsIgnoreCase(material)
            ? StringUtils.tryParseEnum(ParameterMeleeHitSurface.Material.class, material, ParameterMeleeHitSurface.Material.Default)
            : ParameterMeleeHitSurface.Material.MetalGate;
    }
