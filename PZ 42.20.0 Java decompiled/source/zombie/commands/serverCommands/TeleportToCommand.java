...
public class TeleportToCommand extends CommandBase {
    ...
    private String TeleportMeToCoords() {
        ...
        if (this.connection != null) {
            if (!this.connection.getRole().hasCapability(Capability.TeleportToCoordinates)) {
    ...
    private String TeleportUserToCoords() {
        ...
        float z = this.coords[2];
        if (this.connection != null
            && !this.connection.getRole().hasCapability(Capability.TeleportPlayerToAnotherPlayer)
