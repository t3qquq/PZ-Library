...
public enum BloodClothingType {
    ...
    BloodClothingType(final BloodBodyPartType... coveredParts) {
        this(null, coveredParts);
    }

    BloodClothingType(final @Nullable BloodClothingType bloodClothingType, final BloodBodyPartType... bloodBodyPartTypes) {
        ...
        if (itemVisual == null) {
            ...
            if (types == null) {
                ...
                if (bodyParts.isEmpty()) {
                    ...
                    clothing.setDirtiness(total / bodyParts.size());
                }
            }
        }
    }
