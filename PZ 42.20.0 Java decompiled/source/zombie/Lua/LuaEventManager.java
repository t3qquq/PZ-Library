...
public final class LuaEventManager implements JavaFunction {
    ...
    private static Event checkEvent(String event) {
        ...
        if (e == null) {
            DebugType.Lua.println("LuaEventManager: adding unknown event \"" + event + "\"");
            e = AddEvent(event);
        }
    ...
    public static Event AddEvent(String name) {
        ...
        if (LuaManager.env.rawget("Events") instanceof KahluaTable table) {
            ...
            DebugType.Lua.error("ERROR: 'Events' table not found or not a table");
        }
    ...
    private static void AddEvents() {
        ...
        AddEvent("OnJoypadDebugRenderUIOptionSet");
        AddEvent("OnMakeItem");
        ...
        AddEvent("RequestMedicalCheck");
        AddEvent("AcceptedMedicalCheck");
        ...
        AddEvent("OptionControllerButtonStyleChanged");
        AddEvent("OptionGamepadBindingPresetChanged");
    }
