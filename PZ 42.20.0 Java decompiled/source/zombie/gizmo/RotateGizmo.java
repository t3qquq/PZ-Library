...
public class RotateGizmo extends Gizmo {
    ...
    void updateTracking(float uiX, float uiY) {
        ...
        if (this.currentPointOnCircle.equals(pos)) {
            ...
            orientation2 = rotationQuat.getEulerAnglesXYZ(this.allocVector3f());
    ...
    void render() {
        if (this.visible) {
            ...
            if (this.trackAxis == Axis.None || this.trackAxis == Axis.X) {
                ...
                this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, r, 0.0F, 0.0F, stateData.cameraRay);
            }
            ...
            if (this.trackAxis == Axis.None || this.trackAxis == Axis.Y) {
                ...
                this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, 0.0F, g, 0.0F, stateData.cameraRay);
            }
            ...
            if (this.trackAxis == Axis.None || this.trackAxis == Axis.Z) {
                ...
                axisMatrix4f.set(matrix4f);
                this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, 0.0F, 0.0F, b, stateData.cameraRay);
            }
