...
public class SpriteConfigScript extends ComponentScript {
    ...
    public void PreReload() {
        ...
        this.breakSound = IsoThumpable.DEFAULT_BREAK_SOUND.getSoundName();
        ...
        for (SpriteConfigScript.FaceScript faceScript : this.faces) {
            if (faceScript != null) {
                ...
                if (complementaryFace != -1
                    ...
                    && (
                        faceScript.totalWidth != this.getFace(complementaryFace).totalWidth
                            || faceScript.totalHeight != this.getFace(complementaryFace).totalHeight
                    )) {
