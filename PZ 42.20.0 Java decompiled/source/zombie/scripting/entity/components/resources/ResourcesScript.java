        ...
        for (Entry<String, ArrayList<String>> entry : this.groupLines.entrySet()) {
            ...
            for (String line : entry.getValue()) {
                try {
                    ...
                    DebugType.General.printException(e, LogSeverity.Error, "Error in resource blueprint line: " + line + ", entity: " + this.getName());
    ...
    protected void load(ScriptParser.Block block) throws Exception {
        ...
        for (ScriptParser.Block child : block.children) {
            if (child.type.equalsIgnoreCase("group")) {
                ...
                DebugType.General.warn("internal block is deprecated");
            } else if (child.type.equalsIgnoreCase("external")) {
                DebugType.General.warn("external block is deprecated");
            } else {
                DebugType.General.error("Unknown block '" + child.type + "' in entity script: " + this.getName());
            }
        }
    }
