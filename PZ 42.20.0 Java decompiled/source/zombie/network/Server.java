...
public class Server {
    ...
    public String getDisplayAddress() {
        return this.getDisplayIp() + ":" + this.getDisplayPort();
    }

    @UsedFromLua
    public String getDisplayIp() {
        return this.isShowAddressInfoAllowed() ? this.getIp() : "xxx.xxx.xxx.xxx";
    }

    @UsedFromLua
    public String getDisplayPort() {
        return this.isShowAddressInfoAllowed() ? String.valueOf(this.getPort()) : "xxxxxx";
    }
