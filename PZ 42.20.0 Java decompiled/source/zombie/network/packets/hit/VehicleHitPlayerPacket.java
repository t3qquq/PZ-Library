...
@PacketSetting(
    ...
    handlingType = 3,
    anticheats = {AntiCheat.HitDamage, AntiCheat.HitShortDistance, AntiCheat.Safety, AntiCheat.Speed, AntiCheat.HitVehicle}
)
public class VehicleHitPlayerPacket
    ...
    public void set(IsoPlayer wielder, IsoPlayer target, BaseVehicle vehicle, float damage, boolean isTargetHitFromBehind, float vehicleSpeed) {
