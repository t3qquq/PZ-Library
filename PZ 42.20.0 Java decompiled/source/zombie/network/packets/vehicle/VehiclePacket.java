...
public abstract class VehiclePacket implements INetworkPacket {
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        this.square = IsoWorld.instance.currentCell.getGridSquare(this.position.getX(), this.position.getY(), 0.0);
    ...
    protected boolean doRequest(IConnection connection) {
    ...
    protected boolean doRemove(IConnection connection) {
        if (this.vehicleID.isConsistent(connection) && this.square == null) {
