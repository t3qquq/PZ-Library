...
public class NetworkStatistic extends Statistic implements IStatistic {
    ...
    public void addIncomePacket(short id, int size, UdpConnection connection) {
        ...
        if (packetType != null) {
            StatisticManager.getInstance()
                .observeServerPacketProcessDuration(packetType.name(), connection.getUserName() == null ? "" : connection.getUserName(), size);
    ...
    public void addOutcomePacket(short id, int size, UdpConnection connection) {
        ...
        if (packetType != null) {
            StatisticManager.getInstance()
                .observeServerPacketSendDuration(packetType.name(), connection.getUserName() == null ? "" : connection.getUserName(), size);
