...
public class ServerOptions {
    ...
    public ServerOptions.BooleanServerOption announceAnimalDeath = new ServerOptions.BooleanServerOption(this, "AnnounceAnimalDeath", false);
    ...
    public ServerOptions.BooleanServerOption war = new ServerOptions.BooleanServerOption(this, "War", false);
    ...
    public ServerOptions.StringServerOption discordChatChannel = new ServerOptions.StringServerOption(this, "DiscordChatChannel", "", -1);
    public ServerOptions.StringServerOption discordLogChannel = new ServerOptions.StringServerOption(this, "DiscordLogChannel", "", -1);
    public ServerOptions.StringServerOption discordCommandChannel = new ServerOptions.StringServerOption(this, "DiscordCommandChannel", "", -1);
    ...
    public ServerOptions.BooleanServerOption disableSafehouseWhenOwnerConnected = new ServerOptions.BooleanServerOption(
        this, "DisableSafehouseWhenOwnerConnected", false
    );
    ...
    public ServerOptions.IntegerServerOption mapRemotePlayerVisibility = new ServerOptions.IntegerServerOption(this, "MapRemotePlayerVisibility", 1, 4, 1);
    ...
    public ServerOptions.EnumServerOption antiCheatSafety = new ServerOptions.EnumServerOption(this, "AntiCheatSafety", 4, 2);
    public ServerOptions.EnumServerOption antiCheatSpeed = new ServerOptions.EnumServerOption(this, "AntiCheatSpeed", 4, 2);
    public ServerOptions.EnumServerOption antiCheatNoClip = new ServerOptions.EnumServerOption(this, "AntiCheatNoClip", 4, 4);
    public ServerOptions.EnumServerOption antiCheatHit = new ServerOptions.EnumServerOption(this, "AntiCheatHit", 4, 2);
    public ServerOptions.EnumServerOption antiCheatPacketException = new ServerOptions.EnumServerOption(this, "AntiCheatPacketException", 4, 4);
    public ServerOptions.EnumServerOption antiCheatPermission = new ServerOptions.EnumServerOption(this, "AntiCheatPermission", 4, 2);
    public ServerOptions.EnumServerOption antiCheatXp = new ServerOptions.EnumServerOption(this, "AntiCheatXP", 4, 2);
    public ServerOptions.EnumServerOption antiCheatSafeHouse = new ServerOptions.EnumServerOption(this, "AntiCheatSafeHouse", 4, 2);
    public ServerOptions.EnumServerOption antiCheatPlayer = new ServerOptions.EnumServerOption(this, "AntiCheatPlayer", 4, 2);
    public ServerOptions.EnumServerOption antiCheatChecksum = new ServerOptions.EnumServerOption(this, "AntiCheatChecksum", 4, 2);
    ...
    public ServerOptions.IntegerServerOption maxPacketsPerSecond = new ServerOptions.IntegerServerOption(this, "MaxPacketsPerSecond", 100, 1000, 300);
    public ServerOptions.BooleanServerOption showCoordinates = new ServerOptions.BooleanServerOption(this, "ShowCoordinates", false);
    ...
    public void init() {
        ...
        if (serverOptsFile.exists()) {
            try {
                ...
                DebugType.General.printException(e, "Can't load server options", LogSeverity.Error);
            }
    ...
    private static void tryInitSpawnRegionsFile() {
        try {
            ...
            if (!spawnRegionsFile.exists()) {
                DebugType.DetailedInfo.trace("creating server spawnregions file \"" + spawnRegionsFile.getPath() + "\"");
            ...
            if (!spawnPointsFile.exists()) {
                DebugType.DetailedInfo.trace("creating server spawnpoints file \"" + spawnRegionsFile.getPath() + "\"");
            ...
            DebugType.General.printException(e, "Can't initialize spawn regions or spawn points", LogSeverity.Error);
        }
    }
