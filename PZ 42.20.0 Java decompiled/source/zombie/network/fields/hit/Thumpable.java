...
public class Thumpable extends Square implements IPositional, INetworkPacketField {
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        this.index = b.getInt();
        if (this.square != null && this.index > -1 && this.index < this.square.getObjects().size()) {
    ...
    public void process(IsoGameCharacter character) {
        ...
        if (GameServer.server) {
            ...
            if (door != null || thumpable != null) {
                this.isoObject.setRenderEffect(RenderEffectType.Hit_Door, true);
            }
        }
    }
    ...
    public boolean isRelevant(UdpConnection connection) {
        return connection.isRelevantTo(this.getX(), this.getY());
    }
