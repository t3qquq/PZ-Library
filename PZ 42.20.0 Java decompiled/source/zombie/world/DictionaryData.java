        ...
        if (!Core.getInstance().isNoSave()) {
            ...
            if (!path.exists()) {
                ...
                try (FileInputStream inStream = new FileInputStream(path)) {
                    ...
                    DebugType.General.printException(e, LogSeverity.Error, "Error loading WorldDictionary.");
        ...
        if (!Core.getInstance().isNoSave()) {
            ...
            if (path.exists() && path.isDirectory()) {
                ...
                try (FileWriter w = new FileWriter(f, false)) {
                    ...
                    DebugType.General.printException(ex, LogSeverity.Error, "Error saving WorldDictionary as text.");
