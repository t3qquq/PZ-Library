...
public final class WorldMarkers {
    ...
    private void updateDirectionArrows() {
        ...
        for (int plrIndex = 0; plrIndex < this.directionArrows.length; plrIndex++) {
            if (plrIndex == playerIndex && !this.directionArrows[plrIndex].isEmpty()) {
                ...
                for (int index = 0; index < this.directionArrows[plrIndex].size(); index++) {
                    WorldMarkers.DirectionArrow arrow = this.directionArrows[plrIndex].get(index);
    ...
    class PlayerScreen {
        ...
        private final WorldMarkers.Line borderTop = new WorldMarkers.Line(new WorldMarkers.Point(0.0F, 0.0F), new WorldMarkers.Point(0.0F, 0.0F));
        private final WorldMarkers.Line borderRight = new WorldMarkers.Line(new WorldMarkers.Point(0.0F, 0.0F), new WorldMarkers.Point(0.0F, 0.0F));
        private final WorldMarkers.Line borderBot = new WorldMarkers.Line(new WorldMarkers.Point(0.0F, 0.0F), new WorldMarkers.Point(0.0F, 0.0F));
        private final WorldMarkers.Line borderLeft = new WorldMarkers.Line(new WorldMarkers.Point(0.0F, 0.0F), new WorldMarkers.Point(0.0F, 0.0F));
        private final WorldMarkers.Line[] borders = new WorldMarkers.Line[4];
