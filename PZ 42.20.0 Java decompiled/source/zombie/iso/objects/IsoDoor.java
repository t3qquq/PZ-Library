...
public class IsoDoor extends IsoObject implements BarricadeAble, Thumpable, IHasHealth, ILockableDoor, ICurtain {
    public static final int BREAK_SOUND_RADIUS = 70;
    ...
    private void prerender1xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainSopen : this.curtainS)
                    .render(null, x, y - 1.0F, z, this.getForwardIsoDirection(), this.offsetX + 3.0F, this.offsetY + (this.curtainOpen ? -14 : -14), info, true);
            }
        } else if (this.north && !this.isOpen()) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS)
                .render(null, x, y - 1.0F, z, this.getForwardIsoDirection(), this.offsetX - 1.0F - 1.0F, this.offsetY + -15.0F, info, true);
        }
    }
        ...
        if (this.curtainInside) {
            if (this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainNopen : this.curtainN)
                    .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 10.0F - 1.0F, this.offsetY + -10.0F, info, true);
            }
        } else if (!this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN)
                .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 4.0F, this.offsetY + (this.curtainOpen ? -10 : -10), info, true);
        }
    }
        ...
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS)
                .render(
                    ...
                    this.offsetX + (this.curtainOpen ? -14 : -14) / 2,
                    this.offsetY + (this.curtainOpen ? -16 : -16) / 2,
                    info,
                    true
                );
        }
        ...
        if (this.curtainInside) {
            ...
            if (!this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW)
                    .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 2.0F - 1.0F, this.offsetY + -10.0F, info, true);
            }
        } else {
            if (this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW)
                    .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 9.0F, this.offsetY + -10.0F, info, true);
            }
        ...
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainEopen : this.curtainE)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? -13 : -18) / 2,
                    this.offsetY + (this.curtainOpen ? -15 : -18) / 2,
                    info,
                    true
                );
        }
        ...
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainWopen : this.curtainW)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? 0 : 0),
                    this.offsetY + (this.curtainOpen ? 0 : 0),
                    info,
                    true
                );
        }
    ...
    private void prerender2xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainSopen : this.curtainS)
                    .render(
                        null, x, y - 1.0F, z, this.getForwardIsoDirection(), this.offsetX + 7.0F, this.offsetY + (this.curtainOpen ? -28 : -28), info, false
                    );
            }
        } else if (this.north && !this.isOpen()) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS)
                .render(null, x, y - 1.0F, z, this.getForwardIsoDirection(), this.offsetX - 3.0F, this.offsetY + (this.curtainOpen ? -30 : -30), info, false);
        }
    }
    ...
    private void postrender2xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainNopen : this.curtainN)
                    .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 20.0F, this.offsetY + (this.curtainOpen ? -20 : -20), info, false);
            }
        } else if (!this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN)
                .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 8.0F, this.offsetY + (this.curtainOpen ? -20 : -20), info, false);
        }
    }
        ...
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? -14 : -14),
                    this.offsetY + (this.curtainOpen ? -16 : -16),
                    info,
                    false
                );
        }
        ...
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? -28 : -28),
                    this.offsetY + (this.curtainOpen ? -8 : -8),
                    info,
                    false
                );
        }
        ...
        if (this.curtainInside) {
            ...
            (this.curtainOpen ? this.curtainEopen : this.curtainE)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? -22 : -26),
                    this.offsetY + (this.curtainOpen ? -28 : -31),
                    info,
                    false
                );
    ...
    private void postrender2xW(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW)
                    .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 5.0F, this.offsetY + (this.curtainOpen ? -20 : -20), info, false);
            }
        } else if (this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainWopen : this.curtainW)
                .render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 19.0F, this.offsetY + (this.curtainOpen ? -20 : -20), info, false);
        }
    }
        ...
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainEopen : this.curtainE)
                .render(
                    ...
                    z,
                    this.getForwardIsoDirection(),
                    this.offsetX + (this.curtainOpen ? -13 : -18),
                    this.offsetY + (this.curtainOpen ? -15 : -18),
                    info,
                    false
                );
        }
    ...
    public IsoDoor(IsoCell cell, IsoGridSquare gridSquare, IsoSprite gid, boolean north) {
        this.setOpen(gid.getProperties().has(IsoFlagType.open));
        ...
        this.closedSprite = this.isOpen() ? IsoSprite.getSprite(IsoSpriteManager.instance, gid, -openSpriteOffset) : gid;
        this.openSprite = this.isOpen() ? gid : IsoSprite.getSprite(IsoSpriteManager.instance, gid, openSpriteOffset);
        this.sprite = this.isOpen() ? this.openSprite : this.closedSprite;
    ...
    public IsoDoor(IsoCell cell, IsoGridSquare gridSquare, String gid, boolean north) {
        ...
        IsoSprite validSprite = this.isOpen() ? this.openSprite : this.closedSprite;
    ...
    public IsoObject.VisionResult TestVision(IsoGridSquare from, IsoGridSquare to) {
        boolean doorTrans = this.sprite != null && this.sprite.getProperties().has(IsoPropertyType.DOOR_TRANS);
        if (this.sprite != null && this.sprite.getProperties().has(IsoPropertyType.GARAGE_DOOR) && this.isOpen()) {
            doorTrans = true;
        }
            ...
            if (thumper instanceof IsoZombie isoZombie) {
                ...
                if (GameClient.client) {
                    if (isoZombie.isLocal()) {
                        GameClient.connection.thumpHits.put(isoZombie.getOnlineID(), this);
                    }
            ...
            if (this.health <= 0) {
                ...
                if (GameServer.server) {
                    GameServer.PlayWorldSoundServer(
                        (IsoGameCharacter)thumper, this.getSoundPrefix() + "Break", false, thumper.getCurrentSquare(), 0.2F, 70.0F, 1.1F, true
                    );
                }
                    ...
                    if (!this.isOpen()) {
                        if (!this.isDestroyed()) {
                            ...
                            if (weapon.getDoorHitSound() != null) {
                                ParameterMeleeHitSurface.Material material = ParameterMeleeHitSurface.getMaterialFromString(this.getSoundPrefix());
                                if (GameServer.server) {
    ...
    private boolean canBeOpenFromInside(IsoGameCharacter chr) {
        return chr instanceof IsoPlayer
            && !chr.isOutside()
            && (chr.getCurrentSquare().getRoom() == this.getSquare().getRoom() || chr.getCurrentSquare().getRoom() == this.getOppositeSquare().getRoom())
    ...
    public boolean couldBeOpen(IsoGameCharacter chr) {
        if (chr instanceof IsoAnimal) {
            ...
            return false;
        } else if (this.canBeOpenFromInside(chr)) {
            return true;
        } else if (chr instanceof IsoPlayer
            && !DebugOptions.instance.cheat.door.unlock.getValue()
            && (this.isLockedByKey() || this.getModData().rawget("CustomLock") instanceof Boolean customLock && customLock)
    ...
    public void ToggleDoorActual(IsoGameCharacter chr) {
        ...
        if (chr != null && !(chr instanceof IsoAnimal)) {
            if (GameClient.client || GameServer.server) {
                short onlineID = chr.getOnlineID();
                this.forEachDoorObject(object -> object.lastPlayerOnlineId = onlineID);
            }
            ...
            if (this.isBarricaded()) {
                ...
                if (this.canBeOpenFromInside(chr)) {
                    this.locked = false;
                    this.setLockedByKey(false);
                }
                ...
                boolean bUnlock = chr.getInventory().haveThisKeyId(this.getKeyId()) != null;
                ...
                if (this.locked && !bUnlock && !this.isOpen()) {
                    this.playDoorSound(chr.getEmitter(), "Locked");
                    this.setRenderEffect(RenderEffectType.Hit_Door, true);
                } else if (!this.getSprite().getProperties().has(IsoPropertyType.DOUBLE_DOOR)) {
                    if (this.getSprite().getProperties().has(IsoPropertyType.GARAGE_DOOR)) {
                        if (isGarageDoorObstructed(this)) {
                            ...
                            if (wasOpen != this.isOpen()) {
                                this.playDoorSound(chr.getEmitter(), this.isOpen() ? "Open" : "Close");
                            }

                            if (player.isLocalPlayer()) {
                                player.triggerMusicIntensityEvent(this.isOpen() ? "DoorOpen" : "DoorClose");
                            }
                        }
                ...
                } else if (isDoubleDoorObstructed(this)) {
                    this.playDoorSound(chr.getEmitter(), "Blocked");
                    chr.setHaloNote(Translator.getText("IGUI_PlayerText_DoorBlocked"), 255, 255, 255, 256.0F);
                } else {
                    boolean wasOpen = this.isOpen();
    ...
    private void setWasTryingToggleLockedDoor(boolean b) {
        this.forEachDoorObject(object -> object.wasTryingToggleLockedDoor = b);
    }

    private void setWasTryingToggleBarricadedDoor(boolean b) {
        this.forEachDoorObject(object -> object.wasTryingToggleBarricadedDoor = b);
    }

    private void PlayAnimation() {
        SpriteModel spriteModel1 = this.getSpriteModel();
        if (spriteModel1 != null && spriteModel1.animationName != null) {
            IsoObjectAnimations.getInstance().addObject(this, spriteModel1, this.isOpen() ? "Open" : "Close");
        }
    ...
    public void syncIsoObject(boolean bRemote, byte val, UdpConnection source, ByteBufferReader bb) {
        if (GameClient.client || GameServer.server) {
            if (this.square == null) {
                DebugType.Multiplayer.error("ERROR: " + this.getClass().getSimpleName() + " square is null");
                ...
                if (GameClient.client) {
                    ...
                    for (UdpConnection connection : GameServer.udpEngine.connections) {
                        if (connection.isFullyConnected() && connection.isRelevantTo(this.getX(), this.getY())) {
                ...
                DebugType.Multiplayer.error("ERROR: " + this.getClass().getSimpleName() + " ByteBuffer is null");
            } else {
                ...
                if (bRemote) {
                    ...
                    if (GameClient.client && this.lastPlayerOnlineId != -1) {
                        ...
                        if (player != null) {
                            player.getNetworkCharacterAI().setNoCollision(1000L);
                        }
                    }
                    ...
                    if (getDoubleDoorIndex(this) != -1) {
                        if (bOpen != this.isOpen()) {
                            toggleDoubleDoor(this, false);
                            if (player != null) {
                                this.playDoorSound(player.getEmitter(), this.isOpen() ? "Open" : "Close");
                                if (player.isLocalPlayer()) {
                                    player.triggerMusicIntensityEvent(this.isOpen() ? "DoorOpen" : "DoorClose");
                                }
                            }
                        }
                    } else if (bOpen != this.isOpen()) {
                        this.setOpen(bOpen);
                        this.sprite = this.isOpen() ? this.openSprite : this.closedSprite;
                        if (player != null) {
                            this.playDoorSound(player.getEmitter(), this.isOpen() ? "Open" : "Close");
                    ...
                    for (NetObject doorPart : doorParts) {
                        ...
                        if (obj == null || obj.getSquare() == null) {
                            DebugType.General.error("expected IsoDoor index is invalid " + doorPart.getDescription());
                            return;
                        }
                    ...
                    if (GameServer.server) {
                        for (UdpConnection connection : GameServer.udpEngine.connections) {
                            if (connection.isFullyConnected()
                                && connection.isRelevantTo(this.getX(), this.getY())
                                && (source == null || connection.getConnectedGUID() != source.getConnectedGUID())) {
                                ByteBufferWriter b = connection.startPacket();
                                PacketTypes.PacketType.SyncIsoObject.doPacket(b);
                                this.syncIsoObjectSend(b);
                                PacketTypes.PacketType.SyncIsoObject.send(connection);
    ...
    public boolean isBarricadeAllowed() {
        return this.getSprite() != null
            && !this.getSprite().getProperties().has(IsoPropertyType.DOUBLE_DOOR)
            && !this.getSprite().getProperties().has(IsoPropertyType.GARAGE_DOOR);
    }
    ...
    public void setLockedByKey(boolean lockedByKey) {
        this.setLockedByKey(lockedByKey, true);
    }

    public void setLockedByKey(boolean lockedByKey, boolean doSync) {
        boolean changed = lockedByKey != this.lockedByKey;
        this.lockedByKey = lockedByKey;
        this.setIsLocked(lockedByKey);
        if (!GameServer.server && changed && doSync) {
            if (lockedByKey) {
                this.sync(3);
            } else {
                this.sync(4);
    ...
    public boolean canAddCurtain() {
        ...
        if (props == null) {
            return false;
        } else if (props.has(IsoPropertyType.GARAGE_DOOR)) {
            return false;
        } else {
    ...
    public void saveChange(IsoObjectChange change, KahluaTable tbl, ByteBufferWriter bb) {
        if (change == IsoObjectChange.ADD_SHEET) {
            if (tbl != null && tbl.rawget("inside") instanceof Boolean isInside) {
                bb.putBoolean(isInside);
            }
        } else if (change != IsoObjectChange.REMOVE_SHEET) {
            if (change == IsoObjectChange.SET_CURTAIN_OPEN) {
                if (tbl != null && tbl.rawget("open") instanceof Boolean isOpen) {
    ...
    public static void toggleDoubleDoor(IsoObject oneOfFour, boolean doSync) {
        ...
        if (oneOfFourIndex != -1) {
            ...
            boolean open = door == null ? thumpable.open : door.isOpen();
            ...
            if (props != null && props.has(IsoPropertyType.DOUBLE_DOOR)) {
                ...
                if (ddIndex >= 1 && ddIndex <= 8) {
                    ...
                    if (door == null && thump == null) {
                        ...
                        boolean open = door == null ? thump.open : door.isOpen();
                        if (!open) {
                            return ddIndex;
                        } else {
        ...
        if (oneOfFourIndex != -1 && index > 0) {
            ...
            if (door != null) {
                for (int i = 0; i < specialObjects.size(); i++) {
                    ...
                    if (obj instanceof IsoDoor isoDoor && isoDoor.north == north && getDoubleDoorIndex(obj) == index) {
                        return obj;
                    }
                }
            }
    ...
    public static IsoObject getGarageDoorPrev(IsoObject oneOfThree) {
        ...
        if (door != null) {
            for (int i = 0; i < specialObjects.size(); i++) {
                IsoObject obj = specialObjects.get(i);
                if (obj instanceof IsoDoor isoDoor && isoDoor.north == north && getGarageDoorIndex(obj) <= oneOfThreeIndex) {
                    return obj;
                }
            }
        }
        ...
        if (thump != null) {
            for (int i = 0; i < specialObjects.size(); i++) {
                IsoObject obj = specialObjects.get(i);
                if (obj instanceof IsoThumpable isoThumpable && isoThumpable.north == north && getGarageDoorIndex(obj) <= oneOfThreeIndex) {
                    return obj;
                }
            }
        }
    ...
    public void changeSprite(IsoDoor door) {
        door.sprite = door.isOpen() ? door.openSprite : door.closedSprite;
    }
    ...
    private static void toggleGarageDoorObject(IsoObject oneOfThree) {
        ...
        if (oneOfThreeIndex != -1) {
            ...
            if (door != null) {
                door.setOpen(!open);
                door.setLockedByKey(false, false);
                door.sprite = door.isOpen() ? door.openSprite : door.closedSprite;
            }

            if (thumpable != null) {
                thumpable.open = !open;
                thumpable.setLockedByKey(false, false);
    ...
    public static void toggleGarageDoor(IsoObject oneOfThree, boolean doSync) {
        ...
        if (GameClient.client || GameServer.server) {
            oneOfThree.sync(door.isOpen() ? 1 : 0);
        }
    ...
    public IsoObject getRenderEffectMaster() {
        ...
        if (ddIndex != -1) {
            ...
            IsoObject first = getGarageDoorFirst(this);
            if (first != null) {
                return first;
            }
        }
    ...
    public String getThumpSound() {
        String soundName = this.getProperty(IsoPropertyType.THUMP_SOUND);
    ...
    public String getSoundPrefix() {
        ...
        PropertyContainer props = this.closedSprite.getProperties();
        return props.has(IsoPropertyType.DOOR_SOUND) ? props.get(IsoPropertyType.DOOR_SOUND) : "WoodDoor";
    }
    ...
    public static void forEachDoorObject(IsoObject object, Consumer<IsoObject> consumer) {
        if (getDoubleDoorIndex(object) != -1) {
            for (int ddIndex = 1; ddIndex <= 4; ddIndex++) {
                if (getDoubleDoorObject(object, ddIndex) instanceof IsoObject door) {
                    consumer.accept(door);
                }
            }
        } else {
            ...
            if (getGarageDoorIndex(object) != -1) {
                for (IsoObject prev = getGarageDoorPrev(object); prev != null; prev = getGarageDoorPrev(prev)) {
                    consumer.accept(prev);
                }

                for (IsoObject next = getGarageDoorNext(object); next != null; next = getGarageDoorNext(next)) {
