...
public final class IsoObjectPicker {
    ...
    public static final class ClickObject {
        ...
        public IsoObjectPicker.ClickObject set(IsoObjectPicker.ClickObject other) {
        ...
        public boolean contains(float x, float y, int z) {
            return x >= this.x && y >= this.y && x < this.x + this.width && y < this.y + this.height && this.z == z;
        }
