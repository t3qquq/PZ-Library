...
public class FBORenderWorldMarkers {
    ...
    private final ObjectPool<FBORenderWorldMarkers.Marker> highlightPool = new ObjectPool<>(
        FBORenderWorldMarkers.Marker::new, "FBORenderWorldMarkers.highlightPool"
    );
    private final ObjectPool<FBORenderWorldMarkers.Drawer> drawerPool = new ObjectPool<>(FBORenderWorldMarkers.Drawer::new, "FBORenderWorldMarkers.drawerPool");
    ...
    public void render(int z, List<WorldMarkers.GridSquareMarker> markerList) {
        ...
        for (int i = 0; i < this.highlights.size(); i++) {
            FBORenderWorldMarkers.Marker ah1 = this.highlights.get(i);
