...
public class SimplexNoise {
    private static final SimplexNoise.Grad[] grad3 = new SimplexNoise.Grad[]{
    ...
    public static double noise(double x, double y, double z, double w) {
        ...
        double originZ0 = k - t;
        double originW0 = l - t;
        double x0 = x - originX0;
        double y0 = y - originY0;
        double z0 = z - originZ0;
        double w0 = w - originW0;
        int rankx = 0;
        int ranky = 0;
        int rankz = 0;
        int rankw = 0;
