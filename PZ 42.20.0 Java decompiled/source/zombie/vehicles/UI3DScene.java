...
public final class UI3DScene extends UIElement {
    ...
    private static final ObjectPool<UI3DScene.SetModelCamera> s_SetModelCameraPool = new ObjectPool<>(
        UI3DScene.SetModelCamera::new, "UI3DScene.s_SetModelCameraPool"
    );
    ...
    private static final ObjectPool<UI3DScene.PositionRotation> s_posRotPool = new ObjectPool<>(UI3DScene.PositionRotation::new, "UI3DScene.s_posRotPool");
    private final ArrayList<UI3DScene.AABB> aabb = new ArrayList<>();
    private static final ObjectPool<UI3DScene.AABB> s_aabbPool = new ObjectPool<>(UI3DScene.AABB::new, "UI3DScene.s_aabbPool");
    private final ArrayList<UI3DScene.Box3D> box3d = new ArrayList<>();
    private static final ObjectPool<UI3DScene.Box3D> s_box3DPool = new ObjectPool<>(UI3DScene.Box3D::new, "UI3DScene.s_box3DPool");
    private final ArrayList<UI3DScene.PhysicsMesh> physicsMesh = new ArrayList<>();
    private static final ObjectPool<UI3DScene.PhysicsMesh> s_physicsMeshPool = new ObjectPool<>(UI3DScene.PhysicsMesh::new, "UI3DScene.s_physicsMeshPool");
    ...
    public void render() {
        if (this.isVisible()) {
            ...
            for (int i = 0; i < this.objects.size(); i++) {
                UI3DScene.ScenePolygon scenePolygon = Type.tryCastTo(this.objects.get(i), UI3DScene.ScenePolygon.class);
        ...
        switch (func) {
            ...
            case "getGeometryNames":
                ...
                for (UI3DScene.SceneObject sceneObject : this.objects) {
                    if (sceneObject instanceof UI3DScene.SceneGeometry geometry) {
        ...
        switch (func) {
            ...
            case "createPolygon": {
                ...
                if (sceneObject != null) {
                    ...
                    for (int i = 0; i < this.objects.size(); i++) {
                        if (!(this.objects.get(i) instanceof UI3DScene.SceneGeometry)) {
                    ...
                    if (i != spriteGridIndex) {
                        ...
                        if (sprite2 != null) {
                            ...
                            if (geometries != null && !geometries.isEmpty()) {
                                ...
                                float gz1 = spriteGrid.getSpriteGridPosZ(sprite) * 2.4495F;
                                float gx2 = spriteGrid.getSpriteGridPosX(sprite2);
                                float gy2 = spriteGrid.getSpriteGridPosY(sprite2);
                                float gz2 = spriteGrid.getSpriteGridPosZ(sprite2) * 2.4495F;
            ...
            case "setGizmoOrigin":
                ...
                switch (origin) {
                    ...
                    case "chassis":
                        ...
                        break;
                    case "character":
                        this.gizmoParent = this.getSceneObjectById((String)arg1, UI3DScene.SceneCharacter.class, true);
                        this.gizmoOrigin = this.gizmoParent;
                        this.gizmoChild = null;
                        break;
                    case "model":
                        this.gizmoParent = this.getSceneObjectById((String)arg1, UI3DScene.SceneModel.class, true);
                        this.gizmoOrigin = this.gizmoParent;
                        this.gizmoChild = null;
                        break;
                    case "object":
                        this.gizmoParent = this.getSceneObjectById((String)arg1, true);
                        this.gizmoOrigin = this.gizmoParent;
                        this.gizmoChild = null;
                        break;
                    case "vehicleModel":
    ...
    public Object fromLua3(String func, Object arg0, Object arg1, Object arg2) {
        switch (func) {
            ...
            case "placeAttachmentAtOrigin":
                ...
                Matrix4f attachmentXfrm = ModelInstanceRenderData.makeAttachmentTransform(attach, allocMatrix4f());
                ...
                sceneModel.rotate.mul(180.0F / (float)Math.PI);
    ...
    public Object fromLua4(String func, Object arg0, Object arg1, Object arg2, Object arg3) {
        switch (func) {
            case "clearGeometry": {
                ...
                TileGeometryManager.getInstance().setGeometry(modID, tilesetName, col, row, new ArrayList<>());
                return null;
            }
            ...
            case "setHighlightPartBone":
                this.highlightPartBone.vehicle = this.getSceneObjectById((String)arg0, UI3DScene.SceneVehicle.class, true);
            ...
            case "updateGeometryFile": {
                ...
                for (UI3DScene.SceneObject object : this.objects) {
                    if (object instanceof UI3DScene.SceneGeometry sceneGeometry) {
                        TileGeometryFile.Geometry tileGeometry = sceneGeometry.toGeometryFileObject();
    ...
    private void calcMatrices(Matrix4f projection, Matrix4f modelView) {
        ...
        float viewX = this.viewX / this.zoomMult() * scale;
        float viewY = this.viewY / this.zoomMult() * scale;
    ...
    public static float closest_distance_line_circle(UI3DScene.Ray ray, UI3DScene.Circle c, Vector3f point) {
        ...
        Vector3f onPlane = allocVector3f();
        float dist;
        if (intersect_ray_plane(plane, ray, onPlane) == 1) {
    ...
    private static class CharacterRenderData extends UI3DScene.SceneObjectRenderData {
        ...
        private static final ObjectPool<UI3DScene.CharacterRenderData> s_pool = new ObjectPool<>(
            UI3DScene.CharacterRenderData::new, "CharacterRenderData.s_pool"
        );
    ...
    private static class ModelRenderData extends UI3DScene.SceneObjectRenderData {
        ...
        private static final ObjectPool<UI3DScene.ModelRenderData> s_pool = new ObjectPool<>(UI3DScene.ModelRenderData::new, "ModelRenderData.s_pool");
    ...
    private final class OverlaysDrawer extends TextureDraw.GenericDrawer {
        void init() {
            ...
            for (int i = 0; i < UI3DScene.this.axes.size(); i++) {
                UI3DScene.PositionRotation axis = UI3DScene.this.axes.get(i);
    ...
    public static final class PlaneObjectPool extends ObjectPool<UI3DScene.Plane> {
        ...
        public PlaneObjectPool() {
            super(UI3DScene.Plane::new, UI3DScene.Plane.class.getSimpleName());
        }
    ...
    public static final class RayObjectPool extends ObjectPool<UI3DScene.Ray> {
        ...
        public RayObjectPool() {
            super(UI3DScene.Ray::new, UI3DScene.Ray.class.getSimpleName());
        }
    ...
    private final class RotateGizmo extends UI3DScene.Gizmo {
        UI3DScene.Axis trackAxis = UI3DScene.Axis.None;
        boolean snap = true;
        ...
        UI3DScene.Axis hitTest(float uiX, float uiY) {
            ...
            float scalex = UI3DScene.this.gizmoScale / stateData.zoomMult() * 1000.0F;
        ...
        void updateTracking(float uiX, float uiY) {
            ...
            if (this.currentPointOnCircle.equals(pos)) {
                ...
                orientation2 = rotationQuat.getEulerAnglesXYZ(new Vector3f());
        ...
        void render() {
            if (this.visible) {
                ...
                if (this.trackAxis == UI3DScene.Axis.None || this.trackAxis == UI3DScene.Axis.X) {
                    ...
                    this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, r, 0.0F, 0.0F, cameraRay);
                }
                ...
                if (this.trackAxis == UI3DScene.Axis.None || this.trackAxis == UI3DScene.Axis.Y) {
                    ...
                    this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, 0.0F, g, 0.0F, cameraRay);
                }
                ...
                if (this.trackAxis == UI3DScene.Axis.None || this.trackAxis == UI3DScene.Axis.Z) {
                    ...
                    axisMatrix4f.set(matrix4f);
                    this.renderAxis(axisMatrix4f, 0.01F * scalex, radius / 2.0F, 0.0F, 0.0F, b, cameraRay);
                }
        ...
        Vector3f getPointOnAxis(float uiX, float uiY, UI3DScene.Axis axis, UI3DScene.Circle circle, Matrix4f gizmoXfrm, Vector3f out) {
            ...
            UI3DScene.Ray cameraRay = UI3DScene.allocRay();
    ...
    private static final class SceneCylinderDrawer extends TextureDraw.GenericDrawer {
        ...
        int slices = 32;
        int stacks = 2;
        private static final ObjectPool<UI3DScene.SceneCylinderDrawer> s_pool = new ObjectPool<>(
            UI3DScene.SceneCylinderDrawer::new, "SceneCylinderDrawer.s_pool"
        );
    ...
    private static class SceneObjectRenderData {
        ...
        private static final ObjectPool<UI3DScene.SceneObjectRenderData> s_pool = new ObjectPool<>(
            UI3DScene.SceneObjectRenderData::new, "SceneObjectRenderData.s_pool"
        );
    ...
    private static class ScenePolygonRenderData extends UI3DScene.SceneObjectRenderData {
        ...
        private static final ObjectPool<UI3DScene.ScenePolygonRenderData> s_pool = new ObjectPool<>(
            UI3DScene.ScenePolygonRenderData::new, "ScenePolygonRenderData.s_pool"
        );
    ...
    private static final class SceneVehicleModelInfo {
        ...
        private static final ObjectPool<UI3DScene.SceneVehicleModelInfo> s_pool = new ObjectPool<>(
            UI3DScene.SceneVehicleModelInfo::new, "SceneVehicleModelInfo.s_pool"
        );
        ...
        protected void updateAnimationPlayer() {
            ...
            if (animPlayer != null && animPlayer.isReady()) {
                ...
                if (this.part != null) {
                    UI3DScene.SceneVehicleModelInfo modelInfo = this;
    ...
    private final class TranslateGizmo extends UI3DScene.Gizmo {
        ...
        UI3DScene.Axis hitTest(float uiX, float uiY) {
            ...
            float xT = axis.t;
            float camXT = cameraRay.t;
            if (!UI3DScene.this.gizmoAxisVisibleX || xT < offset || xT >= offset + length) {
                xT = Float.MAX_VALUE;
                distX = Float.MAX_VALUE;
            }
            ...
            float yT = axis.t;
            float camYT = cameraRay.t;
            if (!UI3DScene.this.gizmoAxisVisibleY || yT < offset || yT >= offset + length) {
                yT = Float.MAX_VALUE;
                distY = Float.MAX_VALUE;
            }
            ...
            float zT = axis.t;
            float camZT = cameraRay.t;
            if (!UI3DScene.this.gizmoAxisVisibleZ || zT < offset || zT >= offset + length) {
                zT = Float.MAX_VALUE;
                distZ = Float.MAX_VALUE;
            }
        ...
        void render() {
            if (this.visible) {
                ...
                stateData.modelView.mul(matrix4f, matrix4f);
                float scalex = UI3DScene.this.gizmoScale / stateData.zoomMult() * 1000.0F;
                float thickenss = 0.05F * scalex;
                float length = 0.5F * scalex;
                float offset = 0.1F * scalex;
                VBORenderer vbor = VBORenderer.getInstance();
                vbor.cmdPushAndLoadMatrix(5888, matrix4f);
                if (!stateData.translateGizmoRenderData.hideX) {
                    ...
                    matrix4f.translate(0.0F, 0.0F, length);
                    vbor.cmdPushAndMultMatrix(5888, matrix4f);
                    vbor.addCylinder_Fill(thickenss / 2.0F * 2.0F, 0.0F, 0.1F * scalex, 8, 1, r, 0.0F, 0.0F, 1.0F);
                    vbor.cmdPopMatrix(5888);
                }
                ...
                if (!stateData.translateGizmoRenderData.hideY) {
                    ...
                    matrix4f.translate(0.0F, 0.0F, length);
                    vbor.cmdPushAndMultMatrix(5888, matrix4f);
                    vbor.addCylinder_Fill(thickenss / 2.0F * 2.0F, 0.0F, 0.1F * scalex, 8, 1, 0.0F, g, 0.0F, 1.0F);
                    vbor.cmdPopMatrix(5888);
                }
                ...
                if (!stateData.translateGizmoRenderData.hideZ) {
                    ...
                    matrix4f.translate(0.0F, 0.0F, length);
                    vbor.cmdPushAndMultMatrix(5888, matrix4f);
                    vbor.addCylinder_Fill(thickenss / 2.0F * 2.0F, 0.0F, 0.1F * scalex, 8, 1, 0.0F, 0.0F, b, 1.0F);
                    vbor.cmdPopMatrix(5888);
                }
    ...
    private static class VehicleModelRenderData {
        ...
        private static final ObjectPool<UI3DScene.VehicleModelRenderData> s_pool = new ObjectPool<>(
            UI3DScene.VehicleModelRenderData::new, "VehicleModelRenderData.s_pool"
        );
    ...
    private static class VehicleRenderData extends UI3DScene.SceneObjectRenderData {
        ...
        private static final ObjectPool<UI3DScene.VehicleRenderData> s_pool = new ObjectPool<>(UI3DScene.VehicleRenderData::new, "VehicleRenderData.s_pool");
                ...
                if (model != null) {
                    ...
                    if (animationPlayer != null) {
                        ...
                        if (Core.debug && skinningData == null) {
                            DebugType.General.warn("skinningData is null, matrixPalette may be invalid");
                        }
