...
public class ChatManager {
    ...
    public void processJoinChatPacket(ByteBufferReader bb) {
        ...
        switch (type) {
            ...
            case server:
                ...
                break;
            default:
                DebugLog.log("Chat of type '" + type + "' is not supported to join to");
                return;
        }
    ...
    public void processLeaveChatPacket(ByteBufferReader bb) {
        ...
        switch (type) {
            ...
            case radio:
            case server:
                DebugLog.log("Chat type is '" + type + "'. Can't leave it. Ignored.");
                break;
            case whisper:
            ...
            case admin:
                ...
                break;
            default:
                DebugLog.log("Chat of type '" + type + "' is not supported to leave to");
        }
    }
