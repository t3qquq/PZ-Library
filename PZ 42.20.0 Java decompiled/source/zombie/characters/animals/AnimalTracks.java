...
public class AnimalTracks {
    ...
    public static AnimalTracks addAnimalTrack(VirtualAnimal animal, AnimalTracksDefinitions.AnimalTracksType trackType) {
        ...
        broadcastAnimalTrackToAdminsDebug(track, true);
        return track;
    }
    ...
    public static void broadcastAnimalTrackToAdminsDebug(AnimalTracks track, boolean state) {
        if (GameServer.server) {
            for (IsoPlayer player : GameServer.IDToPlayerMap.values()) {
                if (player != null && player.getRole().hasCapability(Capability.AnimalCheats)) {
                    INetworkPacket.send(player, PacketTypes.PacketType.ManageAnimalTrackOnWorldMap, track, state);
                }
            }
        }
    }
    ...
    public String getTrackSprite() {
        ...
        DebugType.Animal.debugln("Couldn't find sprite for track " + this.trackType + " for animal " + this.animalType);
        return null;
    }
