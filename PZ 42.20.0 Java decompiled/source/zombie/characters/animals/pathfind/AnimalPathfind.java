...
public class AnimalPathfind implements IPathRenderer {
    ...
    final ObjectPool<Vector2f> vector2fObjectPool = new ObjectPool<>(Vector2f::new, "AnimalPathfind.vector2fObjectPool");
    final ObjectPool<Vector3f> vector3fObjectPool = new ObjectPool<>(Vector3f::new, "AnimalPathfind.vector3fObjectPool");
