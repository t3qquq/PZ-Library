...
public class AnimalDefinitions {
    ...
    public String feedByHandAnim = "AnimalLureHigh";
    ...
    public static void loadAnimalDefinitions() {
        DebugType.General.println("loadAnimalDefinitions start");
        ...
        if (definitions != null) {
            ...
            DebugType.General.println("loadAnimalDefinitions end");
        }
    }
    ...
    public AnimalGrowStage getGrowStage() {
        if (this.stages != null && !this.stages.isEmpty()) {
            for (int i = 0; i < this.stages.size(); i++) {
                AnimalGrowStage stageCheck = this.stages.get(i);
                if (stageCheck.stage.equals(this.getAnimalType())) {
                    return stageCheck;
                }
            }
