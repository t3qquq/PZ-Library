...
public class AnimalAllele {
    ...
    public AnimalAllele(AnimalAllele allele) {
        this.name = allele.name;
        this.currentValue = allele.currentValue;
        this.trueRatioValue = allele.trueRatioValue;
        this.dominant = allele.dominant;
        this.used = allele.used;
        this.geneticDisorder = allele.geneticDisorder;
    }
