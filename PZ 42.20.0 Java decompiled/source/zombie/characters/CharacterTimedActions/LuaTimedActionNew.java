...
public final class LuaTimedActionNew extends BaseAction implements IPathfinder {
    ...
    public LuaTimedActionNew(KahluaTable table, IsoGameCharacter chr) {
        ...
        Object allowedWhileDraggingCorpses = table.rawget("allowedWhileDraggingCorpses");
        if (stopOnWalk != null) {
        ...
        if (allowedWhileDraggingCorpses != null) {
            this.setAllowedWhileDraggingCorpses(LuaManager.converterManager.fromLuaToJava(allowedWhileDraggingCorpses, Boolean.class));
        }
    ...
    public void interruptWaitToStart() {
        DebugType.Action.trace("%s: interruptWaitToStart", this.table.rawget("Type"));
        LuaManager.caller.pcall(LuaManager.thread, this.table.rawget("interruptWaitToStart"), this.table);
    }

    @Override
    public void start() {
        DebugType.Action.trace("%s: start", this.table.rawget("Type"));
        super.start();
    ...
    @Override
    public void stop() {
        DebugType.Action.trace("%s: stop", this.table.rawget("Type"));
        super.stop();
    ...
    @Override
    public void perform() {
        DebugType.Action.trace("%s: perform", this.table.rawget("Type"));
        super.perform();
    ...
    public void complete() {
        DebugType.Action.trace("%s: complete", this.table.rawget("Type"));
        super.complete();
    ...
    public void Failed(Mover mover) {
        ...
        Object functionObj = this.table.rawget("failedPathfind");
        if (functionObj != null) {
            LuaManager.caller.pcallvoid(LuaManager.thread, functionObj, this.table);
        }
    }
    ...
    public void Succeeded(Path path, Mover mover) {
        ...
        Object functionObj = this.table.rawget("succeededPathfind");
        if (functionObj != null) {
            LuaManager.caller.pcallvoid(LuaManager.thread, functionObj, this.table);
        }
    }
    ...
    public void setCurrentTime(float time) {
        this.currentTime = PZMath.clamp(time, 0.0F, this.maxTime);
    }
