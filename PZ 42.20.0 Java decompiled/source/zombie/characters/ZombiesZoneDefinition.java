...
public final class ZombiesZoneDefinition {
    ...
    public static void dressInRandomOutfit(IsoZombie chr) {
        if (!chr.isSkeleton()) {
            ...
            if (square != null) {
                ZombiesZoneDefinition.PickDefinition pickDef = pickDefinition(square.x, square.y, square.z, chr.isFemale(), false);
                if (pickDef == null) {
    ...
    public static ZombiesZoneDefinition.PickDefinition pickDefinition(int x, int y, int z, boolean bFemale, boolean isOnSpawn) {
    ...
    public static void applyDefinition(IsoZombie chr, Zone zombieZone, ZombiesZoneDefinition.ZZDOutfit zombieToSpawn, boolean bFemale) {
        ...
        chr.getAdvancedAnimator().OnAnimDataChanged(false);
    }
    ...
    public static int pickPersistentOutfit(IsoGridSquare square) {
        ...
        ZombiesZoneDefinition.PickDefinition pickDef = pickDefinition(square.x, square.y, square.z, bFemale, true);
        Outfit outfit;
        if (pickDef == null) {
            String roomName = square.getRoom() == null ? null : square.getRoom().getName();
