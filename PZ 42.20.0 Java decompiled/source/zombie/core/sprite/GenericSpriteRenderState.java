            ...
            if (a != 0.0F) {
                ...
                if (this.texture1Cutaway == null && this.texture2Cutaway == null) {
                    ...
                    if (this.wallShaderTexRender == null) {
                        texd = TextureDraw.Create(this.sprite[this.numSprites], tex, x1, y1, x2, y1, x2, y2, x1, y2, col0, col0, col0, col0, texdModifier);
                    } else {
                        texd = TextureDraw.Create(
                            this.sprite[this.numSprites], tex, this.wallShaderTexRender, x1, y1, x2 - x1, y2 - y1, r, g, b, a, texdModifier
                        );
                    }
                } else {
                    Texture tex0 = tex;
                    ...
                    float tex1OffsetX = tex1 == null ? 0.0F : this.texture1CutawayX % 128;
                    float tex1OffsetY = tex1 == null ? 0.0F : this.texture1CutawayY % 226;
                    ...
                    float x2;
                    float x1 = x2 = PZMath.min(tex0OffsetX + tex0Width, tex1OffsetX + tex1Width, tex2OffsetX + tex2Width);
                    float y1;
                    float y0 = y1 = PZMath.max(tex0OffsetY, tex1OffsetY, tex2OffsetY);
                    float y3;
                    float y2 = y3 = PZMath.min(tex0OffsetY + tex0Height, tex1OffsetY + tex1Height, tex2OffsetY + tex2Height);
                    ...
                    float v3 = 1.0F;
                    if (tex0 != null) {
                        int widthHW = tex0.getWidthHW();
                        int heightHW = tex0.getHeightHW();
                        u0 = (tex0.getXStart() * widthHW + (x0 - tex0OffsetX)) / widthHW;
                        u1 = (tex0.getXStart() * widthHW + (x1 - tex0OffsetX)) / widthHW;
                        u2 = (tex0.getXStart() * widthHW + (x2 - tex0OffsetX)) / widthHW;
                        u3 = (tex0.getXStart() * widthHW + (x3 - tex0OffsetX)) / widthHW;
                        v0 = (tex0.getYStart() * heightHW + (y0 - tex0OffsetY)) / heightHW;
                        v1 = (tex0.getYStart() * heightHW + (y1 - tex0OffsetY)) / heightHW;
                        v2 = (tex0.getYStart() * heightHW + (y2 - tex0OffsetY)) / heightHW;
                        v3 = (tex0.getYStart() * heightHW + (y3 - tex0OffsetY)) / heightHW;
                    }
                    ...
                    if (tex1 != null) {
                        ...
                        texd.tex1 = tex1;
                        texd.tex1U0 = (this.texture1CutawayX + (x0 - tex1OffsetX)) / widthHW;
                        texd.tex1U1 = (this.texture1CutawayX + (x1 - tex1OffsetX)) / widthHW;
                        texd.tex1U2 = (this.texture1CutawayX + (x2 - tex1OffsetX)) / widthHW;
                        texd.tex1U3 = (this.texture1CutawayX + (x3 - tex1OffsetX)) / widthHW;
                        texd.tex1V0 = (this.texture1CutawayY + (y0 - tex1OffsetY)) / heightHW;
                        texd.tex1V1 = (this.texture1CutawayY + (y1 - tex1OffsetY)) / heightHW;
                        texd.tex1V2 = (this.texture1CutawayY + (y2 - tex1OffsetY)) / heightHW;
                        texd.tex1V3 = (this.texture1CutawayY + (y3 - tex1OffsetY)) / heightHW;
                    }
                    ...
                    if (tex2 != null) {
                        ...
                        texd.tex2 = tex2;
                        texd.tex2U0 = (tex2.getXStart() * widthHW + (x0 - tex2OffsetX)) / widthHW;
                        texd.tex2U1 = (tex2.getXStart() * widthHW + (x1 - tex2OffsetX)) / widthHW;
                        texd.tex2U2 = (tex2.getXStart() * widthHW + (x2 - tex2OffsetX)) / widthHW;
                        texd.tex2U3 = (tex2.getXStart() * widthHW + (x3 - tex2OffsetX)) / widthHW;
                        texd.tex2V0 = (tex2.getYStart() * heightHW + (y0 - tex2OffsetY)) / heightHW;
                        texd.tex2V1 = (tex2.getYStart() * heightHW + (y1 - tex2OffsetY)) / heightHW;
                        texd.tex2V2 = (tex2.getYStart() * heightHW + (y2 - tex2OffsetY)) / heightHW;
                        texd.tex2V3 = (tex2.getYStart() * heightHW + (y3 - tex2OffsetY)) / heightHW;
                    }
                }
    ...
    public void render(
        ...
        if (tex == null || tex.isReady()) {
            if (a != 0.0F) {
                ...
                TextureDraw texd;
                if (this.wallShaderTexRender == null) {
                    texd = TextureDraw.Create(this.sprite[this.numSprites], tex, x1, y1, x2, y1, x2, y2, x, y2, col0, col0, col0, col0, texdModifier);
                } else {
                    texd = TextureDraw.Create(this.sprite[this.numSprites], tex, this.wallShaderTexRender, x1, y1, x2 - x1, y2 - y1, r, g, b, a, texdModifier);
                }
