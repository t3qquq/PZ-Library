...
public final class Rand {
    ...
    public static boolean PerThirtiethOfASecond(int chancePerThirtiethOfASecond) {
        float mult = GameTime.getInstance().getThirtyFPSMultiplier();
        return RandStandard.INSTANCE.Next(0.0F, chancePerThirtiethOfASecond * mult) < mult;
    }
