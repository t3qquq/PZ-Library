...
public class RagdollSettingsManager {
            ...
            if (!hitReactionSetting.isEnableAdmin()) {
                ...
                switch (hitReaction) {
                    ...
                    case "ShotHeadFwd02":
                        ...
                        break;
                    default:
                        DebugType.Physics.debugln("RagdollState: HitReaction %s CASE NOT DEFINED", hitReaction);
                }
                ...
                float hitReactionChance = this.getChanceSetting(bodyPart);
    ...
    private RagdollSettingsManager.RagdollSetting initRagdollSetting(int id, String name, float defaultValue, float min, float max) {
        ...
        DebugType.Physics.error("RagdollSetting: id(%i) out of range ", id);
        return null;
    }
    ...
    private RagdollSettingsManager.HitReactionSetting initHitReactionSetting(int id, String name, float defaultValue, float min, float max) {
        ...
        DebugType.Physics.error("HitReactionSetting: id(%i) out of range ", id);
        return null;
    }
    ...
    private RagdollSettingsManager.ForceHitReactionLocation initForceHitReactionLocation(int id, String name) {
        ...
        DebugType.Physics.error("ForceHitReactionLocation: id(%i) out of range ", id);
        return null;
    }
    ...
    public String getForcedHitReactionLocationAsShotLocation() {
        ...
        switch (bodyPartID) {
            ...
            case 10:
                ...
                break;
            default:
                DebugType.Physics.error("RagdollSettingManager: bodyPartID %s CASE NOT DEFINED", bodyPartID);
        }
