...
public final class PhysicsDebugRenderer extends TextureDraw.GenericDrawer {
    private static final ObjectPool<PhysicsDebugRenderer> POOL = new ObjectPool<>(PhysicsDebugRenderer::new, "PhysicsDebugRenderer.POOL");
    ...
    public void drawLine(
        ...
        DebugType.Physics.debugOnceln("Called from JNI");
    ...
    public void drawSphere(float pX, float pY, float pZ, float radius, float r, float g, float b) {
        DebugType.Physics.debugln("[Not Implemented] - Called from JNI");
    }
