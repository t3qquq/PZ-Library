...
public class ShaderParameter {
    ...
    private ShaderParameter(String name, Object value, ShaderParameter.ParameterTypes type) {
    ...
    public ShaderParameter(String name, boolean value) {
        this(name, value, ShaderParameter.ParameterTypes.Bool);
    }

    public ShaderParameter(String name, int value) {
        this(name, value, ShaderParameter.ParameterTypes.Int);
    }

    public ShaderParameter(String name, int value, boolean isTexture) {
        this(name, value, isTexture ? ShaderParameter.ParameterTypes.Texture : ShaderParameter.ParameterTypes.Int);
    }

    public ShaderParameter(String name, float value) {
        this(name, value, ShaderParameter.ParameterTypes.Float);
    }

    public ShaderParameter(String name, Vector2f value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector2);
    }

    public ShaderParameter(String name, Vector3f value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector3);
    }

    public ShaderParameter(String name, Vector4f value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector4);
    }

    public ShaderParameter(String name, Matrix3f value) {
        this(name, value, ShaderParameter.ParameterTypes.Matrix3);
    }

    public ShaderParameter(String name, Matrix4f value) {
        this(name, value, ShaderParameter.ParameterTypes.Matrix4);
    }

    public ShaderParameter(String name, int[] value, boolean isTexture) {
        this(name, value, isTexture ? ShaderParameter.ParameterTypes.TextureArray : ShaderParameter.ParameterTypes.IntArray);
    }

    public ShaderParameter(String name, float[] value) {
        this(name, value, ShaderParameter.ParameterTypes.FloatArray);
    }

    public ShaderParameter(String name, Vector2f[] value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector2Array);
    ...
    public ShaderParameter(String name, Vector3f[] value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector3Array);
    ...
    public ShaderParameter(String name, Vector4f[] value) {
        this(name, value, ShaderParameter.ParameterTypes.Vector4Array);
    ...
    public ShaderParameter(String name, Matrix3f[] value) {
        this(name, value, ShaderParameter.ParameterTypes.Matrix3Array);
    ...
    public ShaderParameter(String name, Matrix4f[] value) {
        this(name, value, ShaderParameter.ParameterTypes.Matrix4Array);
    ...
    private void SetValue(Object value, ShaderParameter.ParameterTypes type) {
        if (type != this.type) {
            String str = String.format("Changing parameter %s from %s to %s", this.name, this.type, type);
            DebugType.Shader.warn(str);
            this.type = type;
            this.defaultValue = value;
        }
    ...
    public void SetBool(boolean value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Bool);
    }

    public void SetInt(int value) {
        if (this.type != ShaderParameter.ParameterTypes.Int || this.value == null || (Integer)this.value != value) {
            this.SetValue(value, ShaderParameter.ParameterTypes.Int);
        }
    }

    public void SetFloat(float value) {
        if (this.type != ShaderParameter.ParameterTypes.Float || this.value == null || (Float)this.value != value) {
            this.SetValue(value, ShaderParameter.ParameterTypes.Float);
        }
    }
    ...
    public void SetTexture(int value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Texture);
    }

    public void SetIntArray(int[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.IntArray);
    }

    public void SetFloatArray(float[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.FloatArray);
    }

    public void SetVector2Array(Vector2f[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Vector2Array);
    }

    public void SetVector3Array(Vector3f[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Vector3Array);
    }

    public void SetVector4Array(Vector4f[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Vector4Array);
    }

    public void SetMatrix3Array(Matrix3f[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Matrix3Array);
    }

    public void SetMatrix4Array(Matrix4f[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.Matrix4Array);
    }

    public void SetTextureArray(int[] value) {
        this.SetValue(value, ShaderParameter.ParameterTypes.TextureArray);
    }
