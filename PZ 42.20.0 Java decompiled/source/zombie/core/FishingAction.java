...
public class FishingAction extends Action {
    ...
    public void start() {
        ...
        DebugType.Action.trace("FishingAction.start %s", this.getDescription());
    }
    ...
    public void stop() {
        ...
        DebugType.Action.trace("FishingAction.stop %s", this.getDescription());
    }
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        if ((this.contentFlag & flagUpdateFish) != 0) {
            ...
            if (hasFish) {
                try {
                    ...
                    this.currentFish.load(b.bb, 249);
                    this.currentFishItem = InventoryItem.loadItem(b.bb, 249);
                } catch (Exception ex) {
                    DebugType.Objects.printException(ex, this.getDescription(), LogSeverity.Error);
                }
            } else {
        ...
        DebugType.Action.trace("FishingAction.parse: %s", this.getDescription());
    }
    ...
    public void write(ByteBufferWriter b) {
        ...
        if ((this.contentFlag & flagUpdateFish) != 0) {
            if (b.putBoolean(this.currentFishItem != null)) {
                try {
                    ...
                    DebugType.Objects.printException(e, this.getDescription(), LogSeverity.Error);
                }
            }
        ...
        DebugType.Action.trace("FishingAction.write: %s", this.getDescription());
    }
