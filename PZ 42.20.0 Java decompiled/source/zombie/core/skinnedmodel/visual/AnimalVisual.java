...
public class AnimalVisual extends BaseVisual {
    ...
    public Model getModel() {
        ...
        if (this.owner instanceof IsoDeadBody corpse) {
            ...
            if (adef.bodyModelFleece != null && ((KahluaTableImpl)corpse.getModData()).rawgetBool("shouldBeBodyFleece")) {
            ...
            if (adef.bodyModelHeadless != null && corpse.getModData() != null && ((KahluaTableImpl)corpse.getModData()).rawgetBool("headless")) {
    ...
    public void copyFrom(BaseVisual baseVisual) {
        if (baseVisual == null) {
            this.clear();
        } else if (baseVisual instanceof AnimalVisual other) {
            this.skinTextureName = other.skinTextureName;
            this.animalRotStage = other.animalRotStage;
        } else {
            throw new IllegalArgumentException("expected AnimalVisual, got " + baseVisual);
        }
    }
}
