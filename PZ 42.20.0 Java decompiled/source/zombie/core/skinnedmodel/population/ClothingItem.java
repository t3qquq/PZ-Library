...
public final class ClothingItem extends Asset {
    ...
    public void getCombinedMask(CharacterMask mask) {
        mask.setPartsVisible(this.masks, false);
    }
    ...
    public static void tryGetCombinedMask(ClothingItemReference itemRef, CharacterMask mask) {
        tryGetCombinedMask(itemRef.getClothingItem(), mask);
    }

    public static void tryGetCombinedMask(ClothingItem item, CharacterMask mask) {
        if (item != null) {
            item.getCombinedMask(mask);
        }
    }
