...
public class LiveAnimNode extends PooledObject implements IAnimListener {
    ...
    private void invokeAnimTimeEvent(AnimationTrack track, AnimEvent.AnimEventTime eventTime) {
        if (this.sourceNode != null) {
            for (AnimEvent event : this.getSourceNode().events) {
    ...
    public int getTransitionTrackId() {
        return this.transitionIn.track != null ? this.transitionIn.track.getId() : -1;
    }
    ...
    public Iterable<AnimationTrack> getMainAnimationTracks() {
        return this.isMainAnimActive() ? this.animationTracks : PZEmptyIterable.getInstance();
    }
    ...
    public boolean incrementWhileAliveFlagOnce(AnimationVariableReference variableReference, boolean whileAliveFlagValue) {
        boolean alreadyExists = PZArrayUtil.contains(this.whileAliveFlags, variableReference, (entry, reference) -> entry.variableReference == reference);
        return alreadyExists ? false : this.whileAliveFlags.add(LiveAnimNode.WhileAliveFlag.alloc(variableReference, whileAliveFlagValue));
    }
    ...
    public static class WhileAliveFlag extends PooledObject {
        ...
        public static LiveAnimNode.WhileAliveFlag alloc(AnimationVariableReference variableReference, boolean whileAliveFlagValue) {
