...
public final class ModelInstanceTextureInitializer {
    ...
    private static final ObjectPool<ModelInstanceTextureInitializer> pool = new ObjectPool<>(
        ModelInstanceTextureInitializer::new, "ModelInstanceTextureInitializer.pool"
    );
