...
public final class IsoObjectAnimations {
    ...
    final ObjectPool<IsoObjectAnimations.AnimatedObject> animatedObjectPool = new ObjectPool<>(
        IsoObjectAnimations.AnimatedObject::new, "IsoObjectAnimations.animatedObjectPool"
    );
