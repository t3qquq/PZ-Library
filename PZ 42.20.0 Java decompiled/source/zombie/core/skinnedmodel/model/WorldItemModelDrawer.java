...
public final class WorldItemModelDrawer extends TextureDraw.GenericDrawer {
    private static final ObjectPool<WorldItemModelDrawer> s_modelDrawerPool = new ObjectPool<>(
        WorldItemModelDrawer::new, "WorldItemModelDrawer.s_modelDrawerPool"
    );
    ...
    public static ItemModelRenderer.RenderStatus renderMain(
        ...
        if (renderAtlasTexture(item, square, x, y, z, flipAngle, forcedRotation, bIgnoreItemsInChunkTexture)) {
        ...
        ItemModelRenderer.RenderStatus status = modelDrawer.renderer
            .renderMain(item, square, renderSquare, x, y, z + adjustedZ, flipAngle, forcedRotation, bRenderToChunkTexture);
    ...
    private static boolean renderAtlasTexture(
        ...
        item.atlasTexture.render(x, y, adjustedZ, sx, sy, tempColorInfo.r, tempColorInfo.g, tempColorInfo.b, alpha);
