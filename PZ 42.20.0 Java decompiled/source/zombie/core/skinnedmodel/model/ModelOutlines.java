...
public final class ModelOutlines {
    ...
    private final ObjectPool<ModelOutlines.Drawer> drawerPool = new ObjectPool<>(ModelOutlines.Drawer::new, "ModelOutlines.drawerPool");
    ...
    public void endFrame(int playerIndex) {
        if (this.dirty) {
            ...
            int viewX = IsoCamera.getScreenLeft(this.playerIndex);
            int viewY = IsoCamera.getScreenTop(this.playerIndex);
            int viewW = IsoCamera.getScreenWidth(this.playerIndex);
            int viewH = IsoCamera.getScreenHeight(this.playerIndex);
            Matrix4f projection = Core.getInstance().projectionMatrixStack.alloc();
            projection.setOrtho2D(0.0F, viewW, viewH, 0.0F);
            ...
            GL11.glViewport(viewX, viewY, viewW, viewH);
            ...
            this.renderTexture(this.fboA.getTexture(), viewX, viewY, viewW, viewH, this.thickenHShader);
            ...
            this.renderTexture(this.fboB.getTexture(), viewX, viewY, viewW, viewH, this.thickenVShader);
            ...
            this.renderTexture(this.fboC.getTexture(), viewX, viewY, viewW, viewH, this.blitShader);
            this.blitShader.End();
