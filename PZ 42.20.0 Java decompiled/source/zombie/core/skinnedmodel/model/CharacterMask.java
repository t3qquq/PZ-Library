...
public final class CharacterMask {
    ...
    public String contentsToString() {
        ...
        while (i < CharacterMask.Part.leaves().length) {
    ...
    public enum Part {
        ...
        Part(final int value) {
            this.value = value;
            this.parent = null;
            this.isSubdivided = false;
        }

        Part(final int value, final CharacterMask.Part parent) {
            this.value = value;
            this.parent = parent;
            this.isSubdivided = false;
        }

        Part(final int value, final boolean isSubdivided) {
            this.value = value;
            this.parent = null;
