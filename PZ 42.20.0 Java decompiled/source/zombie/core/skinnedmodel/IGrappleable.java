...
public interface IGrappleable {
    ...
    default void setTargetGrapplePos(Vector3f grapplePos) {
        this.setTargetGrapplePos(grapplePos.x, grapplePos.y, grapplePos.z);
    }

    default void setTargetGrapplePos(zombie.iso.Vector3 grapplePos) {
        this.setTargetGrapplePos(grapplePos.x, grapplePos.y, grapplePos.z);
    }
    ...
    default void setGrappleDeferredOffset(Vector3f grappleOffset) {
        this.setGrappleDeferredOffset(grappleOffset.x, grappleOffset.y, grappleOffset.z);
    }

    default void setGrappleDeferredOffset(zombie.iso.Vector3 grappleOffset) {
        this.setGrappleDeferredOffset(grappleOffset.x, grappleOffset.y, grappleOffset.z);
    }
    ...
    default void setPosition(zombie.iso.Vector3 position) {
