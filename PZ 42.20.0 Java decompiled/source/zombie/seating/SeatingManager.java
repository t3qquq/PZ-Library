...
public final class SeatingManager {
    ...
    public boolean getAdjacentPosition(
        ...
        if (isoObject != null && isoObject.getSprite() != null && isoObject.getSprite().tilesetName != null) {
            ...
            worldPos.set(isoObject.square.x + 0.5F + localPos.x, isoObject.square.y + 0.5F + localPos.y, isoObject.square.z);
            return true;
        } else {
            return false;
        }
    ...
    public Vector2 getDeferredMovement(BoneAxis boneAxis, org.lwjgl.util.vector.Vector3f bonePos, Vector2 deferredPos) {
