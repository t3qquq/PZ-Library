...
public final class AddCoopPlayer {
    ...
    public void update() {
        switch (this.stage) {
                    ...
                    for (int x = minwx; x < maxwx; x++) {
                        for (int y = minwy; y < maxwy; y++) {
                            if (IsoWorld.instance.getMetaGrid().isValidChunk(x, y)) {
                                IsoChunk chunk = chunkMap.LoadChunkForLater(x, y, x - minwx, y - minwy);
            ...
            case CheckMapLoading:
                ...
                IsoGridSquare sq = cell.getGridSquare(
            ...
            case AddToWorld:
                ...
                cell.addMovingObject(this.player);
    ...
    public void playerCreated(int playerIndex) {
        if (this.player.playerIndex == playerIndex) {
            DebugType.Multiplayer.debugln("created player=%d", playerIndex, (short)4);
            this.stage = AddCoopPlayer.Stage.Init;
        }
    }
