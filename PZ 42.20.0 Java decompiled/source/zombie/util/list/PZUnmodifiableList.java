...
public class PZUnmodifiableList<E> extends PZUnmodifiableCollection<E> implements List<E> {
    ...
    public static <T> List<T> wrap(List<? extends T> list) {
        return list.getClass() == PZUnmodifiableList.class ? list : new PZUnmodifiableList<>(list);
    }
    ...
    public ListIterator<E> listIterator(final int index) {
        return new ListIterator<E>() {
            private final ListIterator<? extends E> i = PZUnmodifiableList.this.list.listIterator(index);
