...
public class PZHash {
    ...
    public static long murmur_64(byte[] data, int length, int seed) {
        ...
        switch (length % 8) {
            case 7:
                h ^= (long)(data[(length & -8) + 6] & 0xFF) << 48;
            case 6:
                h ^= (long)(data[(length & -8) + 5] & 0xFF) << 40;
            case 5:
                h ^= (long)(data[(length & -8) + 4] & 0xFF) << 32;
            case 4:
                h ^= (long)(data[(length & -8) + 3] & 0xFF) << 24;
            case 3:
                h ^= (long)(data[(length & -8) + 2] & 0xFF) << 16;
            case 2:
                h ^= (long)(data[(length & -8) + 1] & 0xFF) << 8;
            case 1:
                h ^= data[length & -8] & 0xFF;
                h *= -4132994306676758123L;
            default:
                h ^= h >>> 47;
                h *= -4132994306676758123L;
