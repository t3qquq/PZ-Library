...
public final class Lambda {
    ...
    public static <E, T1> void forEach(Consumer<Consumer<E>> forEachFunction, T1 captureVal1, Consumers.Params1.ICallback<E, T1> lambdaFunc) {
        capture(
            ...
            captureVal1,
            lambdaFunc,
            (stack, lForEachFunction, lCaptureVal1, lLambdaFunc) -> lForEachFunction.accept(stack.consumer(lCaptureVal1, lLambdaFunc))
        );
    }
    ...
    public static <E, T1, T2> void forEach(
        ...
        capture(
            ...
            captureVal2,
            lambdaFunc,
            (stack, lForEachFunction, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lForEachFunction.accept(
                stack.consumer(lCaptureVal1, lCaptureVal2, lLambdaFunc)
            )
        );
    }
    ...
    public static <E, T1> void forEachFrom(
        ...
        capture(
            ...
            captureVal1,
            lambdaFunc,
            (stack, lForEachFunction, lFrom, lCaptureVal1, lLambdaFunc) -> lForEachFunction.accept(lFrom, stack.consumer(lCaptureVal1, lLambdaFunc))
        );
    }
    ...
    public static <E, T1, T2> void forEachFrom(
        ...
        capture(
            ...
            captureVal2,
            lambdaFunc,
            (stack, lForEachFunction, lFrom, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lForEachFunction.accept(
                lFrom, stack.consumer(lCaptureVal1, lCaptureVal2, lLambdaFunc)
            )
        );
    }
    ...
    public static <E, F, T1, T2, T3> void forEachFrom(
        ...
        capture(
            ...
            captureVal3,
            lambdaFunc,
            (stack, lForEachFunction, lFrom, lCaptureval1, lCaptureVal2, lCaptureVal3, lLambdaFunc) -> lForEachFunction.accept(
                lFrom, stack.consumer(lCaptureval1, lCaptureVal2, lCaptureVal3, lLambdaFunc)
            )
        );
    }
    ...
    public static <E, F, T1, T2, T3, T4> void forEachFrom(
        ...
        capture(
            ...
            captureVal4,
            lambdaFunc,
            (stack, lForEachFunction, lFrom, lCaptureVal1, lCaptureVal2, lCaptureVal3, lCaptureVal4, lLambdaFunc) -> lForEachFunction.accept(
                lFrom, stack.consumer(lCaptureVal1, lCaptureVal2, lCaptureVal3, lCaptureVal4, lLambdaFunc)
            )
        );
    }
    ...
    public static <E, T1, R> R find(Function<Predicate<E>, R> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ...
        capture(
            ...
            lambdaFunc,
            returnContainer,
            (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> lReturnContainer.returnVal = lFindFunction.apply(
                stack.predicate(lCaptureVal1, lLambdaFunc)
            )
        );
    ...
    public static <E, T1> int indexOf(IntSupplierFunction<Predicate<E>> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ...
        capture(
            ...
            lambdaFunc,
            returnContainer,
            (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> lReturnContainer.returnVal = lFindFunction.getInt(
                stack.predicate(lCaptureVal1, lLambdaFunc)
            )
        );
    ...
    public static <E, T1> boolean contains(Predicate<Predicate<E>> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ...
        capture(
            ...
            lambdaFunc,
            returnContainer,
            (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> lReturnContainer.returnVal = lFindFunction.test(
                stack.predicate(lCaptureVal1, lLambdaFunc)
            )
        );
    ...
    public static <E, F extends Iterable<E>, T1> boolean containsFrom(
        ...
        capture(
            ...
            lambdaFunc,
            returnContainer,
            (stack, lFindFunction, lFrom, lCaptureVal1, lLambdaFunc, lReturnContainer) -> lReturnContainer.returnVal = lFindFunction.test(
                lFrom, stack.predicate(lCaptureVal1, lLambdaFunc)
            )
        );
        boolean returnval = returnContainer.returnVal;
        returnContainer.release();
    ...
    public static <T1> void invoke(Consumer<Runnable> runFunction, T1 captureVal1, Invokers.Params1.ICallback<T1> lambdaFunc) {
        capture(
            ...
            captureVal1,
            lambdaFunc,
            (stack, lRunFunction, lCaptureVal1, lLambdaFunc) -> lRunFunction.accept(stack.invoker(lCaptureVal1, lLambdaFunc))
        );
    }
    ...
    public static <T1, T2> void invoke(Consumer<Runnable> runFunction, T1 captureVal1, T2 captureVal2, Invokers.Params2.ICallback<T1, T2> lambdaFunc) {
        capture(
            ...
            captureVal2,
            lambdaFunc,
            (stack, lRunFunction, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lRunFunction.accept(stack.invoker(lCaptureVal1, lCaptureVal2, lLambdaFunc))
        );
    }
}
