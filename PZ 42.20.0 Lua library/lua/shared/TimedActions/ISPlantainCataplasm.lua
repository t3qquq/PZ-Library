...
function ISPlantainCataplasm:complete()
    ...
    -- BD_plantainFactor
    syncBodyPart(self.bodyPart, 0x0000000800000000);

    return true;
end

function ISPlantainCataplasm:getDuration()
...
function ISPlantainCataplasm:new(character, otherPlayer, item, bodyPart)
