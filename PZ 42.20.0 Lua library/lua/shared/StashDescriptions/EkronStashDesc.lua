...
stashMap.buildingX = 390
stashMap.buildingY = 9624
...
stashMap:addStamp("ArrowNorth", nil, 416, 9832, 0.650, 0.054, 0.054);
stashMap:addStamp("Pill", nil, 405, 9865, 0.129, 0.129, 0.129);
stashMap:addStamp("Apple", nil, 419, 9864,  0.0, 0.129, 0.129, 0.129);
stashMap:addStamp("Gun", nil, 433, 9864, 0.129, 0.129, 0.129);
...
stashMap.spawnTable = "MedicalCache1";
stashMap:addContainer("MedicalBox", nil, "Base.Bag_DuffelBagTINT", "bathroom", nil,nil,nil)
...
stashMap.buildingY = 0
stashMap:addStamp("ArrowSouthEast", nil, 192, 9481, 0.129,0.129,0.129)
stashMap:addStamp(nil, "Stash_EkronMap7_Text1", 153, 9447, 0.129,0.129,0.129)
stashMap:addStamp("Egg", nil, 47, 9431, 0.129,0.129,0.129)
...
stashMap.buildingY = 0
stashMap:addStamp("ArrowSouthWest", nil, 1757, 8362, 0.129,0.129,0.129)
stashMap:addStamp(nil, "Stash_EkronMap8_Text1", 1775, 8350, 0.129,0.129,0.129)
stashMap:addStamp("X", nil, 1982, 8596, 0.129,0.129,0.129)
stashMap:addStamp(nil, "Stash_EkronMap8_Text2", 1927, 8616, 0.129,0.129,0.129)
