local light_oak_forest = {
    features = {
        ...
        BUSH = {
            { f = worldgen.features.BUSH.bush_primaryforest, p = 0.05 },
        },
        TREE = {
            { f = worldgen.features.TREE.maple_jumbo_xxl, p = 0.053125 },
            { f = worldgen.features.TREE.maple_jumbo_xl, p = 0.053125 },
            { f = worldgen.features.TREE.maple_jumbo, p = 0.003125 },
            { f = worldgen.features.TREE.maple, p = 0.003125 },

            { f = worldgen.features.TREE.linden_jumbo_xxl, p = 0.0015625 },
            { f = worldgen.features.TREE.linden_jumbo_xl, p = 0.0015625 },
            { f = worldgen.features.TREE.linden_jumbo, p = 0.0015625 },
            { f = worldgen.features.TREE.linden, p = 0.0015625 },
