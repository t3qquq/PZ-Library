local farmmix_forest = {
    features = {
        TREE = {
            { f = worldgen.features.TREE.yellowwood_jumbo,             p = 0.05 },
            { f = worldgen.features.TREE.yellowwood_jumbo_xl,          p = 0.05 },
            { f = worldgen.features.TREE.yellowwood_jumbo_xxl,         p = 0.08 },
            ...
            { f = worldgen.features.TREE.silverbell_jumbo,              p = 0.05 },
            { f = worldgen.features.TREE.silverbell_jumbo_xl,           p = 0.05 },
