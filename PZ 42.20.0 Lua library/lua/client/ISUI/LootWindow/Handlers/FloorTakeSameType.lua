...
ISLootWindowFloorControlHandler_TakeSameType = ISLootWindowFloorControlHandler:derive("ISLootWindowFloorControlHandler_TakeSameType")
local Handler = ISLootWindowFloorControlHandler_TakeSameType
