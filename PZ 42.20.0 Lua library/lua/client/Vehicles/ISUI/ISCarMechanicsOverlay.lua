...
--
ISCarMechanicsOverlay.PartList["TrailerAnimalFood"] = {img="storage_foodcompartment", vehicles = {}};
ISCarMechanicsOverlay.PartList["TrailerAnimalEggs"] = {img="storage_eggcompartment", vehicles = {}};
