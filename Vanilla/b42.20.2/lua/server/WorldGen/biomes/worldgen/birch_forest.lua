local birch_forest = {
    features = {
        ...
        BUSH = {
            { f = worldgen.features.BUSH.bush_birchforest, p = 0.1 },
        },
        TREE = {
            { f = worldgen.features.TREE.birch_jumbo_xxl, p = 0.1 },
            { f = worldgen.features.TREE.birch_jumbo_xl, p = 0.1 },
            { f = worldgen.features.TREE.birch_jumbo, p = 0.0125 },
            { f = worldgen.features.TREE.birch, p = 0.0125 },

            { f = worldgen.features.TREE.hawthorn_jumbo_xxl, p = 0.005 },
            { f = worldgen.features.TREE.hawthorn_jumbo_xl, p = 0.005 },
            { f = worldgen.features.TREE.hawthorn_jumbo, p = 0.00125 },
            { f = worldgen.features.TREE.hawthorn, p = 0.00125 },

            { f = worldgen.features.TREE.yellowwood_jumbo_xxl, p = 0.005 },
            { f = worldgen.features.TREE.yellowwood_jumbo_xl, p = 0.005 },
            { f = worldgen.features.TREE.yellowwood_jumbo_xl, p = 0.00125 },
            { f = worldgen.features.TREE.yellowwood_jumbo_xl, p = 0.00125 },
