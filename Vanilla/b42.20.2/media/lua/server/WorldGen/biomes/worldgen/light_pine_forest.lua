local light_pine_forest = {
    features = {
        ...
        TREE = {
            { f = worldgen.features.TREE.pine_jumbo_xxl, p = 0.0177075 },
            { f = worldgen.features.TREE.pine_jumbo_xl, p = 0.0177075 },
            { f = worldgen.features.TREE.pine_jumbo, p = 0.003125 },
            { f = worldgen.features.TREE.pine, p = 0.003125 },

            { f = worldgen.features.TREE.holly_jumbo_xxl, p = 0.0177075 },
            { f = worldgen.features.TREE.holly_jumbo_xl, p = 0.0177075 },
            { f = worldgen.features.TREE.holly_jumbo, p = 0.003125 },
            { f = worldgen.features.TREE.holly, p = 0.003125 },

            { f = worldgen.features.TREE.hemlock_jumbo_xxl, p = 0.0177075 },
            { f = worldgen.features.TREE.hemlock_jumbo_xl, p = 0.0177075 },
            { f = worldgen.features.TREE.hemlock_jumbo, p = 0.003125 },
            { f = worldgen.features.TREE.hemlock, p = 0.003125 },
