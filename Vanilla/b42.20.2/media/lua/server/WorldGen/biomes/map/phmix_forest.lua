local phmix_forest = {
    features = {
        TREE = {
            { f = worldgen.features.TREE.pine_jumbo_xxl,            p = 0.1 },
            { f = worldgen.features.TREE.pine_jumbo_xl,             p = 0.2 },
            { f = worldgen.features.TREE.pine_jumbo,                p = 0.1 },
            { f = worldgen.features.BUSH.bush_phforest,             p = 0.025 },
            { f = worldgen.features.ORE.boulderslow_prim,           p = 0.08 },
            { f = worldgen.features.PLANT.grass_high,               p = 0.025 },
            { f = worldgen.features.TREE.dogwood_jumbo,             p = 0.025 },
            { f = worldgen.features.TREE.dogwood_jumbo_xl,          p = 0.025 },
            { f = worldgen.features.TREE.dogwood_jumbo_xxl,         p = 0.07 },
            { f = worldgen.features.TREE.maple_jumbo,               p = 0.05 },
            ...
            { f = worldgen.features.TREE.linden_jumbo_xl,           p = 0.05 },
