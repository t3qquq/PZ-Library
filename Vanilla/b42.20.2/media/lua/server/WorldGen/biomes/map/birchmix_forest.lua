local birchmix_forest = {
    features = {
        TREE = {
            { f = worldgen.features.TREE.birch_jumbo_xxl,      p = 0.15 },
            { f = worldgen.features.TREE.birch_jumbo_xl,       p = 0.2 },
            { f = worldgen.features.TREE.birch_jumbo,          p = 0.05 },
            { f = worldgen.features.BUSH.bush_regular,         p = 0.05 },
            { f = worldgen.features.ORE.boulderslow_prim,      p = 0.05 }, 
            ...
            { f = worldgen.features.TREE.maple_jumbo_xxl,           p = 0.08 },
