...
function JoypadIconTextureGetter:getWidthOrig()
    return  self.texture:getWidthOrig()
end

function JoypadIconTextureGetter:getHeightOrig()
    return  self.texture:getHeightOrig()
end
