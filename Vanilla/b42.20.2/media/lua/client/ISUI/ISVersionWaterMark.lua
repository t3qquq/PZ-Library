...
function WaterMarkUI:render()
    ...
    local alpha = 0.3;
    if isDebugEnabled() or not isClient() and getSandboxOptions():isUnstableScriptNameSpam() or isClient() and getServerOptions():getBoolean("ShowCoordinates") then
