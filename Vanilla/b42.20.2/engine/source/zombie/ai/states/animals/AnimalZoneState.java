...
public final class AnimalZoneState extends State {
    ...
    public static final State.Param<AnimalZoneState.ZoneState> STATE = State.Param.of("state", AnimalZoneState.ZoneState.class);
    ...
    public void enter(IsoGameCharacter owner) {
        ...
        owner.set(STATE, new AnimalZoneState.StateFollow((IsoAnimal)owner));
    }

    @Override
    public void execute(IsoGameCharacter owner) {
        AnimalZoneState.ZoneState zoneState = owner.get(STATE);
        zoneState.update();
    }
    ...
    private abstract static class ZoneState {
        ...
        String getCurrentZoneAction() {
            return this.animal.get(AnimalZoneState.ACTION);
        }

        void setCurrentZoneAction(String action) {
            this.animal.set(AnimalZoneState.ACTION, action);
        }

        void setState(AnimalZoneState.ZoneState state) {
            this.animal.set(AnimalZoneState.STATE, state);
        }
