                    ...
                    if (effect != null && model.mesh != null && model.mesh.isReady()) {
                        ...
                        if (texture == null) {
                            ...
                            if (effect.getShaderProgram().getName().equalsIgnoreCase("door")) {
                                ...
                                effect.getShaderProgram().setValue("UVOffset", tempVector21.set(x1 / widthHW, y1 / heightHW));
                                effect.getShaderProgram().setValue("UVScale", tempVector21.set((x2 - x1) / widthHW, (y2 - y1) / heightHW));
                            }
                        }
