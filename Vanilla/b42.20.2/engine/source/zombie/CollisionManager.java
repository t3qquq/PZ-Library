...
public final class CollisionManager {
    ...
    public void ResolveContacts() {
        try (AbstractPerformanceProfileProbe var1 = CollisionManager.s_performance.profile_ResolveContacts.profile()) {
    ...
    private void resolveContactsInternal() {
        ...
        for (int i = 0; i < numContacts; i++) {
            CollisionManager.Contact c = this.contactMap.get(i);
