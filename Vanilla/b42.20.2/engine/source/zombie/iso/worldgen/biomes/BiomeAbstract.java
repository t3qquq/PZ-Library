...
public abstract class BiomeAbstract implements IBiome {
    ...
    protected Map<FeatureType, Map<FeatureType, List<IBiome>>> subBiomes = new HashMap<>();
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return this.generate == that.generate
                ...
                && Objects.equals(this.subBiomes, that.subBiomes)
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.subBiomes);
