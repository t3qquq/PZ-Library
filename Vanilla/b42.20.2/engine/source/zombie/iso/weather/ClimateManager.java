...
public class ClimateManager {
    ...
    public static final long PUDDLES_BROADCAST_INTERVAL_MS = 10000L;
    ...
    private final UpdateLimit puddlesSyncLimit = new UpdateLimit(10000L);
    ...
    public float getDayLightStrength() {
        return IsoPlayer.getInstance() != null && IsoPlayer.getInstance().isAlwaysDayCheat() ? 1.0F : this.dayLightStrength.finalValue;
    }

    public float getNightStrength() {
        return IsoPlayer.getInstance() != null && IsoPlayer.getInstance().isAlwaysDayCheat() ? 0.0F : this.nightStrength.finalValue;
    }
    ...
    public float getAmbient() {
        return IsoPlayer.getInstance() != null && IsoPlayer.getInstance().isAlwaysDayCheat() ? 1.0F : this.ambient.finalValue;
    }
