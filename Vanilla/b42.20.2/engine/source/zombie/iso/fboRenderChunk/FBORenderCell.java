...
public final class FBORenderCell {
    ...
    private final ObjectPool<IsoGameCharacter.Location> locationPool = new ObjectPool<>(IsoGameCharacter.Location::new, "FBORenderCell.locationPool");
    ...
    public void renderInternal() {
        ...
        try (GameProfiler.ProfileArea var24 = GameProfiler.getInstance().profile("renderLast")) {
            for (IsoMovingObject obj : this.cell.getObjectList()) {
                obj.renderlast();
            }

            for (int i = 0; i < this.cell.getStaticUpdaterObjectList().size(); i++) {
                IsoObject obj = this.cell.getStaticUpdaterObjectList().get(i);
                obj.renderlast();
            }
        }
    ...
    public void RenderTiles(int minHeight, int maxHeight) {
        ...
        try (AbstractPerformanceProfileProbe var3 = IsoCell.s_performance.isoCellRenderTiles.profile()) {
    ...
    private void renderTilesInternal(int maxHeight) {
        ...
        if (DebugOptions.instance.terrain.renderTiles.enable.getValue()) {
            ...
            try (GameProfiler.ProfileArea bForceCutawayUpdate = GameProfiler.getInstance().profile("updateWeatherMask")) {
            ...
            try (GameProfiler.ProfileArea size = GameProfiler.getInstance().profile("runChecks")) {
                bForceCutawayUpdate |= this.runChecks(playerIndex);
            }

            try (AbstractPerformanceProfileProbe var39 = IsoCell.s_performance.renderTiles.recalculateAnyGridStacks.profile()) {
                if (checkFuture != null) {
            ...
            try (AbstractPerformanceProfileProbe var41 = cutaways.profile()) {
            ...
            try (AbstractPerformanceProfileProbe var43 = updateLighting.profile()) {
            ...
            try (AbstractPerformanceProfileProbe var44 = IsoCell.s_performance.renderTiles.performRenderTiles.profile()) {
            ...
            try (AbstractPerformanceProfileProbe var45 = IsoCell.s_performance.renderTiles.renderDebugPhysics.profile()) {
                this.cell.renderDebugPhysics(playerIndex);
            }

            try (AbstractPerformanceProfileProbe var46 = IsoCell.s_performance.renderTiles.renderDebugLighting.profile()) {
    ...
    private boolean runChecks(int playerIndex) {
        ...
        boolean result;
        try (GameProfiler.ProfileArea var4 = profiler.profile("Newly")) {
            result = this.checkNewlyOnScreenChunks(playerIndex);
        }

        try (GameProfiler.ProfileArea var13 = profiler.profile("Obscuring")) {
            this.checkObjectsObscuringPlayer(playerIndex);
            this.checkFadingInObjectsObscuringPlayer(playerIndex);
        }

        try (GameProfiler.ProfileArea var14 = profiler.profile("Chunks")) {
    ...
    private void performRenderTiles(IsoCell.PerPlayerRender perPlayerRender, int playerIndex, long currentTimeMillis) {
        ...
        for (int i = 0; i < perPlayerData1.onScreenChunks.size(); i++) {
            ...
            try (AbstractPerformanceProfileProbe var10 = renderOneChunk.profile()) {
        ...
        if (PerformanceSettings.puddlesQuality < 2) {
            try (AbstractPerformanceProfileProbe var29 = puddles.profile()) {
        ...
        try (AbstractPerformanceProfileProbe var30 = water.profile()) {
        ...
        for (int z = chunkMap.minHeight; z <= chunkMap.maxHeight; z++) {
            ...
            try (AbstractPerformanceProfileProbe var34 = translucentFloor.profile()) {
            ...
            try (AbstractPerformanceProfileProbe var35 = puddles.profile()) {
            ...
            if (z == PZMath.fastfloor(IsoCamera.frameState.camCharacterZ)) {
                ...
                try (GameProfiler.ProfileArea var36 = GameProfiler.getInstance().profile("Visibility")) {
            ...
            try (AbstractPerformanceProfileProbe var37 = translucentNonFloor.profile()) {
        ...
        try (AbstractPerformanceProfileProbe var33 = fog.profile()) {
        ...
        if (c != null && c.IsOnScreen(true)) {
            if (!c.lightingNeverDone[playerIndex]) {
                ...
                for (int zza = c.minLevel; zza <= c.maxLevel; zza++) {
                    try (AbstractPerformanceProfileProbe var10 = renderOneChunkLevel.profile()) {
    ...
    private void renderOneLevel(
        ...
        if (!renderLevels.isOnScreen(level)) {
            ...
            if (isDirty && canRender) {
                ...
                try (AbstractPerformanceProfileProbe var17 = calculateRenderInfo.profile()) {
                    ...
                    for (int i = 0; i < squares.length; i++) {
                        ...
                        if (levelData.shouldRenderSquare(playerIndex, square) && !FBORenderOcclusion.getInstance().isOccluded(square.x, square.y, square.z)) {
                            if (!square.getObjects().isEmpty()) {
                                ...
                                try (GameProfiler.ProfileArea squarex = profiler.profile("Calculate")) {
                                ...
                                try (GameProfiler.ProfileArea var85 = profiler.profile("Puddles")) {
                ...
                try (AbstractPerformanceProfileProbe var56 = renderOneChunkLevel2.profile()) {
                    if (level == renderLevels.getMinLevel(level)) {
                    ...
                    if (renderFloor) {
                        try (GameProfiler.ProfileArea var59 = profiler.profile("Floor")) {
                        ...
                        try (GameProfiler.ProfileArea var60 = profiler.profile("Snow")) {
                            IndieGL.disableDepthTest();
                            FBORenderSnow.getInstance().RenderSnow(c, level);
                            IndieGL.enableDepthTest();
                        }

                        try (GameProfiler.ProfileArea var61 = profiler.profile("Blood")) {
                    ...
                    if (DebugOptions.instance.terrain.renderTiles.vegetationCorpses.getValue()) {
                        try (GameProfiler.ProfileArea var62 = profiler.profile("Vegetation Corpses")) {
                            if (DebugOptions.instance.fboRenderChunk.corpsesInChunkTexture.getValue()) {
                    ...
                    if (DebugOptions.instance.terrain.renderTiles.minusFloorCharacters.getValue()) {
                        try (GameProfiler.ProfileArea var63 = profiler.profile("Minus Floor Chars")) {
                            if (DebugOptions.instance.fboRenderChunk.itemsInChunkTexture.getValue()) {
                                IsoGridSquare squareNW = c.getGridSquare(0, 0, level);
                                IsoGridSquare squareN = squareNW == null ? null : squareNW.getAdjacentSquare(IsoDirections.N);
                                if (squareNW != null && squareN != null) {
                            ...
                            for (int i = 0; i < IsoCell.MinusFloorCharacters.size(); i++) {
                                squareN = IsoCell.MinusFloorCharacters.get(i);
                    ...
                    if (PerformanceSettings.puddlesQuality == 2) {
                        try (GameProfiler.ProfileArea var64 = profiler.profile("Low Puddles")) {
                            this.renderPuddlesToChunkTexture(playerIndex, level, c);
                        }
                    }

                    try (GameProfiler.ProfileArea var65 = profiler.profile("Add Chunk")) {
    ...
    private ObjectRenderLayer calculateObjectRenderLayer(IsoObject object) {
        if (!object.getDoRender()) {
            ...
            return object.getSprite() != null && (object.getSprite().depthFlags & 2) != 0 ? ObjectRenderLayer.TranslucentSE : ObjectRenderLayer.MinusFloorSE;
        } else {
        ...
        if (DebugOptions.instance.terrain.renderTiles.bloodDecals.getValue()) {
            ...
            if (optionBloodDecals != 0) {
                ...
                for (int i = 0; i < chunk.floorBloodSplats.size(); i++) {
                    IsoFloorBloodSplat b = chunk.floorBloodSplats.get(i);
                    if ((b.index < 1 || b.index > 10 || IsoChunk.renderByIndex[optionBloodDecals - 1][b.index - 1] != 0)
                        && !(cx + b.x < minX)
                        && !(cx + b.x > maxX)
                        && !(cy + b.y < minY)
    ...
    private void renderOneLevel_Translucent(int playerIndex, IsoChunk c, int level) {
        ...
        if (renderLevels.isOnScreen(level)) {
            ...
            if (squaresObjects.size() + squaresItems.size() + squaresCutawayOutlines.size() != 0) {
                ...
                try (GameProfiler.ProfileArea i = GameProfiler.getInstance().profile("Sort")) {
                ...
                for (int i = 0; i < sorted.size(); i++) {
                    IsoGridSquare square = sorted.get(i);
                    if (square.z == level && levelData.shouldRenderSquare(playerIndex, square) && square.IsOnScreen()) {
                            ...
                            if (renderLevels.isOnScreen(z)) {
                                ...
                                for (int n = squares.size(); j < n; j++) {
                                    ...
                                    if (square.IsOnScreen()
                                        && IsoWater.getInstance().getShaderEnable()
                                        && square.getWater() != null
                                        && square.getWater().isValid()) {
                            ...
                            for (int j = 0; j < numObjects; j++) {
                                ...
                                if (object != null
                                    ...
                                    object.renderAttachedAndOverlaySprites(
                                        ...
                                        square.y,
                                        square.z,
                                        square.getLightInfo(playerIndex),
                                        true,
                                        false,
                                        null,
                                        null
                                    ...
                                    for (int j = 0; j < squares.length; j++) {
                                        ...
                                        if (levelData.shouldRenderSquare(playerIndex, square)) {
                                            ...
                                            for (int k = 0; k < numObjects; k++) {
                                                ...
                                                ObjectRenderInfo renderInfo = object.getRenderInfo(playerIndex);
                                                if (renderInfo.layer == ObjectRenderLayer.MinusFloor) {
                                                    try (GameProfiler.ProfileArea var17 = GameProfiler.getInstance().profile("ImprovedFog")) {
