...
public final class FBORenderObjectOutline {
    ...
    private final ObjectPool<FBORenderObjectOutline.Drawer> drawerPool = new ObjectPool<>(
        FBORenderObjectOutline.Drawer::new, "FBORenderObjectOutline.drawerPool"
    );
    private final ObjectPool<FBORenderObjectOutline.Drawer2> drawer2Pool = new ObjectPool<>(
        FBORenderObjectOutline.Drawer2::new, "FBORenderObjectOutline.drawer2Pool"
    );
