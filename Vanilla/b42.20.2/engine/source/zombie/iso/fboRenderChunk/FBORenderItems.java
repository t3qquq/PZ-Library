...
public final class FBORenderItems {
    ...
    private final ObjectPool<FBORenderItems.RenderJob> jobPool = new ObjectPool<>(FBORenderItems.RenderJob::new, "FBORenderItems.jobPool");
    ...
    private static final class RenderJob extends TextureDraw.GenericDrawer {
        ...
        IsoObject getObject() {
            return this.trap != null ? this.trap : this.worldInventoryObject;
        }
