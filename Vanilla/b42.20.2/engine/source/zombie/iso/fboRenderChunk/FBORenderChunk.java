...
public final class FBORenderChunk {
    ...
    public static final int FLOOR_WIDTH = 64 * Core.tileScale;
    public static final int FLOOR_HEIGHT = 32 * Core.tileScale;
    public static final int JUMBO_L_WIDTH = FLOOR_WIDTH * 3;
    public static final int JUMBO_L_HEIGHT = FLOOR_HEIGHT * 8;
    public static final int JUMBO_XL_WIDTH = FLOOR_WIDTH * 5;
    public static final int JUMBO_XL_HEIGHT = FLOOR_HEIGHT * 12;
    public static final int JUMBO_XXL_WIDTH = FLOOR_WIDTH * 7;
    public static final int JUMBO_XXL_HEIGHT = FLOOR_HEIGHT * 16;
