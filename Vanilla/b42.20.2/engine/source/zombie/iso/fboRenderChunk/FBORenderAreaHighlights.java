...
public class FBORenderAreaHighlights {
    ...
    private final ObjectPool<FBORenderAreaHighlights.AreaHighlight> highlightPool = new ObjectPool<>(
        FBORenderAreaHighlights.AreaHighlight::new, "FBORenderAreaHighlights.highlightPool"
    );
    private final ObjectPool<FBORenderAreaHighlights.Drawer> drawerPool = new ObjectPool<>(
        FBORenderAreaHighlights.Drawer::new, "FBORenderAreaHighlights.drawerPool"
    );
