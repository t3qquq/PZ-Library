...
public final class IsoBulletTracerEffects {
    ...
    private final ObjectPool<IsoBulletTracerEffects.Effect> effectPool = new ObjectPool<>(
        IsoBulletTracerEffects.Effect::new, "IsoBulletTracerEffects.effectPool"
    );
