...
public class IsoFloorBloodSplat {
    ...
    public void load(ByteBuffer input, int worldVersion) throws IOException {
        this.x = PZMath.fastfloor(input.get() & 0xFF) / 255.0F * 8.0F;
        this.y = PZMath.fastfloor(input.get() & 0xFF) / 255.0F * 8.0F;
        this.z = PZMath.fastfloor(input.get() & 0xFF) / 255.0F * 8.0F;
        this.type = input.get();
