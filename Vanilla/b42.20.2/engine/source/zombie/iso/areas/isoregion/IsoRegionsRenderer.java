    ...
    private void _render(UIElement ui, float zoom, float xPos, float yPos) {
        ...
        if (this.isEditingEnabled()) {
            ...
            if (this.editWallN.getValue() || this.editDoorN.getValue()) {
                ...
                this.renderRect(this.editSquareX, this.editSquareY + 0.2F, 1.0F, 0.05F, r, g, 0.0F, 1.0F);
                this.renderRect(this.editSquareX + 0.95F, this.editSquareY, 0.05F, 0.25F, r, g, 0.0F, 1.0F);
                ...
                this.renderRect(this.editSquareX, this.editSquareY + 0.95F, 1.0F, 0.05F, r, g, 0.0F, 1.0F);
                this.renderRect(this.editSquareX + 0.95F, this.editSquareY, 0.05F, 1.0F, r, g, 0.0F, 1.0F);
            } else {
                ...
                this.renderRect(this.editSquareX, this.editSquareY, 0.05F, 1.0F, r, g, 0.0F, 1.0F);
                this.renderRect(this.editSquareX, this.editSquareY + 0.95F, 0.25F, 0.05F, r, g, 0.0F, 1.0F);
                this.renderRect(this.editSquareX + 0.2F, this.editSquareY, 0.05F, 1.0F, r, g, 0.0F, 1.0F);
            }
        }
