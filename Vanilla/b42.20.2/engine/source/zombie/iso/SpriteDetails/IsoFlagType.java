...
public enum IsoFlagType {
    ...
    DoubleDoor2(107),
    IsFloorAttached(108),
    FloorAttachmentN(109),
    FloorAttachmentS(110),
    FloorAttachmentE(111),
    FloorAttachmentW(112),
    MAX(113);
    ...
    public static IsoFlagType FromString(String str) {
        return fromStringMap.getOrDefault(str, MAX);
    }

    static {
        for (IsoFlagType e : values()) {
            if (e == MAX) {
                break;
            }
