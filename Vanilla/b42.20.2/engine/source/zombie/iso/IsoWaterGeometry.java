...
public final class IsoWaterGeometry {
    ...
    public static final ObjectPool<IsoWaterGeometry> pool = new ObjectPool<>(IsoWaterGeometry::new, "IsoWaterGeometry.pool");
    ...
    private void initRender() {
        if (this.square != null) {
            ...
            float dy1 = 0.0F;
            if (this.shore) {
                IsoGridSquare gs01 = this.square.getAdjacentSquare(IsoDirections.W);
                IsoGridSquare gs12 = this.square.getAdjacentSquare(IsoDirections.S);
            ...
            this.x[0] = IsoUtils.XToScreen(this.square.x + dx0, this.square.y, this.square.z, 0);
            this.y[0] = IsoUtils.YToScreen(this.square.x + dx0, this.square.y, this.square.z, 0);
            this.x[1] = IsoUtils.XToScreen(this.square.x + dx0, this.square.y + 1 + dy1, this.square.z, 0);
            this.y[1] = IsoUtils.YToScreen(this.square.x + dx0, this.square.y + 1 + dy1, this.square.z, 0);
            this.x[2] = IsoUtils.XToScreen(this.square.x + 1, this.square.y + 1 + dy1, this.square.z, 0);
            this.y[2] = IsoUtils.YToScreen(this.square.x + 1, this.square.y + 1 + dy1, this.square.z, 0);
            this.x[3] = IsoUtils.XToScreen(this.square.x + 1, this.square.y, this.square.z, 0);
            this.y[3] = IsoUtils.YToScreen(this.square.x + 1, this.square.y, this.square.z, 0);
            Vector2f v = IsoWaterFlow.getFlow(this.square, 0, 0, tempVector2f);
            this.flow[0] = v.x;
            this.speed[0] = v.y;
            v = IsoWaterFlow.getFlow(this.square, 0, 1, v);
            this.flow[1] = v.x;
            this.speed[1] = v.y;
            v = IsoWaterFlow.getFlow(this.square, 1, 1, v);
            this.flow[2] = v.x;
            this.speed[2] = v.y;
            v = IsoWaterFlow.getFlow(this.square, 1, 0, v);
            this.flow[3] = v.x;
            this.speed[3] = v.y;
        }
    }
