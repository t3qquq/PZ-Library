...
public final class IsoAnim {
    ...
    public void LoadFramesUseOtherFrame(String objectName, String variant, String animName, String otherAnimName, int nOtherFrameFrame, String pal) {
        ...
        for (int n = 0; n < 1; n++) {
            ...
            IsoDirectionFrame frame = new IsoDirectionFrame(
                Texture.getSharedTexture(pre + "8_" + a + palstr + ".png"),
                Texture.getSharedTexture(pre + "9_" + a + palstr + ".png"),
                Texture.getSharedTexture(pre + "6_" + a + palstr + ".png"),
                Texture.getSharedTexture(pre + "3_" + a + palstr + ".png"),
                Texture.getSharedTexture(pre + "2_" + a + palstr + ".png")
            );
            this.frames.add(frame);
        }
    ...
    public void LoadFramesBits(String objectName, String variant, String animName, int nFrames) {
        ...
        for (int n = 0; n < nFrames; n++) {
            int a = n;
            IsoDirectionFrame frame = new IsoDirectionFrame(
                Texture.getSharedTexture(pre + "8_" + a + ".png"),
                Texture.getSharedTexture(pre + "9_" + a + ".png"),
                Texture.getSharedTexture(pre + "6_" + a + ".png"),
                Texture.getSharedTexture(pre + "3_" + a + ".png"),
                Texture.getSharedTexture(pre + "2_" + a + ".png")
            );
            this.frames.add(frame);
        }
    ...
    public void LoadFramesBitRepeatFrame(String objectName, String animName, int repeatFrame) {
        ...
        int a = repeatFrame;
        IsoDirectionFrame frame = new IsoDirectionFrame(
            Texture.getSharedTexture(animName + "8_" + a + ".png"),
            Texture.getSharedTexture(animName + "9_" + a + ".png"),
            Texture.getSharedTexture(animName + "6_" + a + ".png"),
            Texture.getSharedTexture(animName + "3_" + a + ".png"),
            Texture.getSharedTexture(animName + "2_" + a + ".png")
        );
        this.frames.add(frame);
        this.finishUnloopedOnFrame = (short)(this.frames.size() - 1);
        this.framesArray = this.frames.toArray(this.framesArray);
    ...
    void LoadFramesPalette(String objectName, String animName, int nFrames, String palette) {
        ...
        for (int n = 0; n < nFrames; n++) {
            int a = n;
            IsoDirectionFrame frame = new IsoDirectionFrame(
                Texture.getSharedTexture(pre + "8" + post + a + "_" + palette),
                Texture.getSharedTexture(pre + "9" + post + a + "_" + palette),
                Texture.getSharedTexture(pre + "6" + post + a + "_" + palette),
                Texture.getSharedTexture(pre + "3" + post + a + "_" + palette),
                Texture.getSharedTexture(pre + "2" + post + a + "_" + palette)
            );
            this.frames.add(frame);
        }
