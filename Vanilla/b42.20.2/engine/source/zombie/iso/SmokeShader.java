...
public final class SmokeShader extends Shader {
    ...
    public SmokeShader(String name) {
        super(name);
    }
    ...
    public void updateSmokeParams(TextureDraw texd, int userId, float firetime) {
        ParticlesFire f = ParticlesFire.getInstance();
        GL13.glActiveTexture(33984);
        f.getFireSmokeTexture().bind();
        GL11.glTexEnvi(8960, 8704, 7681);
        GL20.glUniformMatrix4fv(this.mvpMatrix, true, f.getMVPMatrix());
        GL20.glUniform1f(this.fireTime, firetime);
