    ...
    public void spawnElement(VehicleStorySpawner spawner, VehicleStorySpawner.Element element) {
        ...
        if (square != null) {
            ...
            switch (element.id) {
                case "tire1":
                    if (vehicle1 != null) {
                        InventoryItem newTire = RandomizedBuildingBase.trySpawnStoryItem(
                            "Base.ModernTire" + vehicle1.getScript().getMechanicType(), square, xoff, yoff, 0.0F
                        );
                        if (newTire != null) {
                ...
                case "tire2":
                    if (vehicle1 != null) {
                        InventoryItem oldTire = RandomizedBuildingBase.trySpawnStoryItem(
                            "Base.OldTire" + vehicle1.getScript().getMechanicType(), square, xoff, yoff, 0.0F
                        );
                        if (oldTire != null) {
