            ...
            switch (element.id) {
                case "vehicle1":
                    ...
                    if (vehicle1 != null) {
                        ...
                        vehicle1.setBloodIntensity("Front", Rand.Next(0.7F, 1.0F));
                        vehicle1.setBloodIntensity("Rear", Rand.Next(0.7F, 1.0F));
                        vehicle1.setBloodIntensity("Left", Rand.Next(0.7F, 1.0F));
                        vehicle1.setBloodIntensity("Right", Rand.Next(0.7F, 1.0F));
                        String victimOutfit = null;
                        if (vehicle1.getZombieType() != null) {
                            victimOutfit = vehicle1.getRandomZombieType();
                        }

                        ArrayList<IsoZombie> zedList = this.addZombiesOnVehicle(Rand.Next(2, 4), victimOutfit, null, vehicle1);
                        if (zedList != null) {
                            ...
                            this.addZombiesOnVehicle(Rand.Next(12, 20), null, null, vehicle1);
                        }
                    }
            }
        }
