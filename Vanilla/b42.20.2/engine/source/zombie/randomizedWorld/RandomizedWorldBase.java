...
public class RandomizedWorldBase {
    ...
    public BaseVehicle addVehicleFlipped(
        ...
        IsoGridSquare sq = IsoWorld.instance.currentCell.getGridSquare(vehicleX, vehicleY, vehicleZ);
        if (sq == null) {
            return null;
        }
    ...
    public static IsoDeadBody createRandomDeadBody(IsoGridSquare sq, IsoDirections dir, int blood, int crawlerChance, String outfit) {
        ...
        return createRandomDeadBody(
            sq.x + Rand.Next(0.05F, 0.95F), sq.y + Rand.Next(0.05F, 0.95F), sq.z, dir.ToVector().getDirection(), bRandomDirection, blood, crawlerChance, outfit
        );
    }
    ...
    public InventoryItem addItemToObjectSurface(String item, IsoObject object) {
        return trySpawnStoryItem(item, object, false);
    }
    ...
    public InventoryItem trySpawnStoryItem(String itemType, IsoGridSquare square, float x, float y, float z, boolean fill) {
        return SandboxOptions.instance.removeStoryLoot.getValue() && ItemPickerJava.getLootModifier(itemType) == 0.0F
            ? null
            : ItemSpawner.spawnItem(itemType, square, x, y, z, fill);
    }

    public static InventoryItem trySpawnStoryItem(String itemType, IsoGridSquare square, float x, float y, float z) {
        return SandboxOptions.instance.removeStoryLoot.getValue() && ItemPickerJava.getLootModifier(itemType) == 0.0F
            ? null
            : ItemSpawner.spawnItem(itemType, square, x, y, z);
    }

    public static InventoryItem trySpawnStoryItem(InventoryItem item, IsoGridSquare square, float x, float y, float z) {
        return SandboxOptions.instance.removeStoryLoot.getValue() && ItemPickerJava.getLootModifier(item.getFullType()) == 0.0F
            ? null
            : ItemSpawner.spawnItem(item, square, x, y, z);
    }
    ...
    public static InventoryItem trySpawnStoryItem(String itemType, IsoObject obj, Boolean randomRotation) {
        return SandboxOptions.instance.removeStoryLoot.getValue() && ItemPickerJava.getLootModifier(itemType) == 0.0F
            ? null
            : obj.spawnItemToObjectSurface(itemType, randomRotation);
    }
}
