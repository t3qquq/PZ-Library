                        ...
                        for (int i = 0; i < sq.getObjects().size(); i++) {
                            ...
                            if (Rand.NextBool(2) && "location_restaurant_pizzawhirled_01_16".equals(obj.getSprite().getName())) {
                                ...
                                for (int j = 0; j < money; j++) {
                                    if (Rand.NextBool(8)) {
                                        trySpawnStoryItem("MoneyBundle", sq, Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                                    } else {
                                        trySpawnStoryItem("Money", sq, Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                                    }
                                }

                                int clothing = Rand.Next(1, 4);

                                for (int j = 0; j < clothing; j++) {
                                    ...
                                    switch (clotheType) {
                                        case 1:
                                            ...
                                            break;
                                        case 2:
                                            trySpawnStoryItem("Vest_DefaultTEXTURE_TINT", sq, Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                                        ...
                                        case 3:
                                            ...
                                            break;
                                        case 4:
                                            trySpawnStoryItem(maleVenue ? "Hat_Cowboy" : "Garter", sq, Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                                            alreadyAddedClothes.add(4);
                                            break;
                                        case 5:
                                            if (!maleVenue) {
                                                trySpawnStoryItem("StockingsBlack", sq, Rand.Next(0.0F, 0.5F), Rand.Next(0.0F, 0.5F), 0.0F);
                                            }
                            ...
                            if (obj.hasAdjacentCanStandSquare()
                                ...
                                for (int j = 0; j < money; j++) {
                                    trySpawnStoryItem("Money", sq, Rand.Next(0.5F, 1.0F), Rand.Next(0.5F, 1.0F), obj.getSurfaceOffsetNoTable() / 96.0F);
                                }
                                ...
                                switch (alcohol) {
                                    case 0:
                                        trySpawnStoryItem("Whiskey", sq, Rand.Next(0.5F, 1.0F), Rand.Next(0.5F, 1.0F), obj.getSurfaceOffsetNoTable() / 96.0F);
                                        break;
                                    case 1:
                                        trySpawnStoryItem("Champagne", sq, Rand.Next(0.5F, 1.0F), Rand.Next(0.5F, 1.0F), obj.getSurfaceOffsetNoTable() / 96.0F);
                                        break;
                                    case 2:
                                        trySpawnStoryItem("Champagne", sq, Rand.Next(0.5F, 1.0F), Rand.Next(0.5F, 1.0F), obj.getSurfaceOffsetNoTable() / 96.0F);
                                        break;
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        trySpawnStoryItem("BeerBottle", sq, Rand.Next(0.5F, 1.0F), Rand.Next(0.5F, 1.0F), obj.getSurfaceOffsetNoTable() / 96.0F);
                                }
                            }
                        }
                    }
