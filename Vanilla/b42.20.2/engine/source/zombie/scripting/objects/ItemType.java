...
public class ItemType {
    ...
    private ItemType(String translationName) {
        this.translationName = "IGUI_ItemType_" + translationName;
    }
    ...
    private static ItemType register(boolean allowDefaultNamespace, String id) {
        return Registries.ITEM_TYPE.register(RegistryReset.createLocation(id, allowDefaultNamespace), new ItemType(id));
    }
}
