...
public class Registries {
    ...
    public static final Registry<Catalogue> CATALOGUE = register("catalogue", () -> Catalogue.AA_RON_HUNTING_SUPPLIES);
    ...
    public static final Registry<Doodle> DOODLE = register("doodle", () -> Doodle.A_BATTLE);
    public static final Registry<DoodleKids> DOODLE_KIDS = register("doodle_kids", () -> DoodleKids.A_CARTOON_CHARACTER);
    public static final Registry<Flier> FLIER = register("flier", () -> Flier.A1_HAY);
    public static final Registry<GameMode> GAME_MODE = register("game_mode", () -> GameMode.APOCALYPSE);
    public static final Registry<Letter> LETTER = register("genericMail", () -> Letter.ACCEPTANCE_LETTER);
    public static final Registry<Locket> LOCKET = register("locket", () -> Locket.A_BIRTHDAY_PARTY);
    ...
    public static final Registry<Postcard> POSTCARD = register("postcard", () -> Postcard.ALASKA);
    public static final Registry<RpgManual> RPG_MANUAL = register("rpg_magazine", () -> RpgManual.ADVENTURE_MANAGER_IMAGINATION_RULEBOOK);
    public static final Registry<SeasonRecipe> SEASON_RECIPE = register("season_recipe", () -> SeasonRecipe.BARLEY_GROWING_SEASON);
    public static final Registry<SoundKey> SOUND_KEY = register("sound_key", () -> SoundKey.ACOUSTIC_GUITAR_BREAK);
    public static final Registry<SurvivalGuideEntry> SURVIVAL_GUIDE_ENTRY = register("survival_guide_entry", () -> SurvivalGuideEntry.MOVEMENT);
    public static final Registry<WeaponCategory> WEAPON_CATEGORY = register("weapon_category", () -> WeaponCategory.BLUNT);
    public static final Registry<ContainerType> CONTAINER_TYPE = register("container_type", () -> ContainerType.BARBECUE);
            ...
            REGISTRY.forEach(
                registry -> {
                    ...
                    try {
                        ...
                        throw new IllegalStateException(
                            "Registry %s of %s should not override equals(Object)".formatted(REGISTRY.getLocation((Registry<?>)registry), clazz.getName())
                        );
                    } catch (NoSuchMethodException var5) {
                        try {
                            clazz.getDeclaredMethod("hashCode");
                            throw new IllegalStateException(
                                "Registry %s of %s should not override hashCode()".formatted(REGISTRY.getLocation((Registry<?>)registry), clazz.getName())
                            );
