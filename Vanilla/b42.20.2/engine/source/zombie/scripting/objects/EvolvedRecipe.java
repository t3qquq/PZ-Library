...
public final class EvolvedRecipe extends BaseScriptObject {
    ...
    public InventoryItem addItem(InventoryItem baseItem, InventoryItem usedItem, IsoGameCharacter chr) {
            ...
            if (item != null) {
                ...
                if (baseItem instanceof Food food) {
                    ...
                    if (oldBaseItem instanceof Food && oldBaseItem.getOffAgeMax() != 1000000000 && baseItem.getOffAgeMax() != 1000000000) {
                        ...
                        baseItem.setAge(baseItem.getOffAgeMax() * age);
                    }
        ...
        if (usedItem instanceof Food food && food.getPoisonPower() > 0) {
    ...
    private void addPoison(InventoryItem usedItem, InventoryItem baseItem, IsoGameCharacter chr, ItemContainer usedItemContainer) {
        ...
        if (baseItem instanceof Food baseItemFood) {
            ...
            if (GameServer.server) {
                ...
                INetworkPacket.sendToRelative(PacketTypes.PacketType.SyncItemModData, (int)chr.getX(), (int)chr.getY(), baseItem);
