                ...
                if (!s.trim().isEmpty() && s.contains("=")) {
                    ...
                    if (k.equalsIgnoreCase("Capacity")) {
                        ...
                        if (StringUtils.containsWhitespace(v)) {
                            DebugType.General.error("Sanitizing container name '" + v + "', name may not contain whitespaces.");
                    ...
                    } else if (k.equalsIgnoreCase("TransferRate")) {
                        this.transferRate = Float.parseFloat(v);
                    }
                }
            } else {
        ...
        for (ScriptParser.Block child : block.children) {
            if (child.type.equalsIgnoreCase("Fluid")) {
                ...
                if (fs != null) {
                    ...
                    DebugType.General.warn("Unable to read fluid block.");
                }
            }
        }
    }
    ...
    public static class FluidScript {
        ...
        public Fluid getFluid() {
            if (this.fluid == null) {
                ...
                if (this.fluid == null) {
                    DebugType.General.warn("Cannot find fluid '" + this.fluidType + "' in fluid script.");
                }
            }
