                ...
                case Zone:
                    if (selectorBucket.hasSelectorIDs()) {
                        for (int i = 0; i < this.zoneCount; i++) {
                            if (selectorBucket.containsSelectorID(this.zones[i])) {
                                return true;
                            }
                        }
                    }
    ...
    public static ItemPickInfo GetPickInfo(ItemContainer container, ItemPickInfo.Caller caller) {
        ...
        if (container == null) {
            ...
            if (containerName != null) {
                instance.containerId = ItemConfigurator.GetIdForString(containerName);
            ...
            if (sq != null) {
                ...
                String roomName = sq.getRoom() != null ? sq.getRoom().getName() : null;
                if (roomName != null) {
                    instance.roomId = ItemConfigurator.GetIdForString(roomName);
                ...
                DebugLog.log("ItemPickInfo -> unable to set source grid pick info, Caller: " + caller + ", for Container: " + containerName);
