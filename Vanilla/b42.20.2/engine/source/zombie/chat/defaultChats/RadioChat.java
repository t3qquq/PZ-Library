...
public class RadioChat extends RangeBasedChat {
    public RadioChat(ByteBufferReader bb, ChatTab tab, IsoPlayer owner) {
    ...
    public ChatMessage unpackMessage(ByteBufferReader bb) {
        ...
        msg.setOverHeadSpeech(bb.getBoolean());
        msg.setShowInChat(bb.getBoolean());
        msg.setShouldAttractZombies(bb.getBoolean());
        return msg;
    }
