...
public class NoClipCommand extends CommandBase {
    ...
    protected String Command() {
        ...
        if (this.getCommandArgsCount() == 2 || this.getCommandArgsCount() == 1 && !firstArg.equals("-true") && !firstArg.equals("-false")) {
            username = firstArg;
            if (this.connection != null && !this.connection.getRole().hasCapability(Capability.ToggleNoclipEveryone)) {
                return "Not enough rights";
            }
        } else if (this.connection != null && !this.connection.getRole().hasCapability(Capability.ToggleNoclipHimself)) {
            return "Not enough rights";
        }
