...
public class LightningCommand extends CommandBase {
    public LightningCommand(String username, Role userRole, String command, UdpConnection connection) {
    ...
    protected String Command() {
        ...
        ClimateManager.getInstance().transmitServerTriggerLightning(x, y, false, true, true);
