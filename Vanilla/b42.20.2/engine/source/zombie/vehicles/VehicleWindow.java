...
public final class VehicleWindow {
    ...
    public void setOpen(boolean open) {
        this.open = open;
        this.part.getOwner().updateDamageOverlayLater();
    }
        ...
        if (amount > 0) {
            if (this.isHittable()) {
                if (GameClient.client) {
                    GameClient.instance
                        .sendClientCommandV(
                            null, "vehicle", "damageWindow", "vehicle", this.part.getVehicle().getId(), "part", this.part.getId(), "amount", amount
                        );
                } else {
                    ...
                    if (this.isDestroyed()) {
                        ...
                        IsoGridSquare square = this.part.getVehicle().getSquare();
