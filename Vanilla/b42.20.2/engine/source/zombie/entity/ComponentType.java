...
public enum ComponentType {
    ...
    <T extends Component, E extends ComponentScript> ComponentType(final short i, final Class<T> componentClass, final Class<E> scriptClass, final int flags) {
        this(i, componentClass, scriptClass, flags, EnumBitStore.allOf(GameEntityType.class));
    }

    <T extends Component, E extends ComponentScript> ComponentType(
    ...
    static {
        ...
        for (ComponentType type : values()) {
            ...
            maxIndex = PZMath.max(maxIndex, type.GetID());
