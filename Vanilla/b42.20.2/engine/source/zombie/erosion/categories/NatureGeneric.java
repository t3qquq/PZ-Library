...
public final class NatureGeneric extends ErosionCategory {
        ...
        for (int i = objsSize - 1; i >= 1; i--) {
            ...
            if (spr != null && spr.getName() != null) {
                ...
                if (spr.getName().startsWith("e_newgrass_1_") || spr.getName().startsWith("d_generic_1_")) {
                    ...
                    if (erosionObj != null) {
                        String cname = spr.getProperties().get(IsoPropertyType.CUSTOM_NAME);
                        if (cname == null || !cname.contains("Twig") && !cname.contains("Branch")) {
                            NatureGeneric.CategoryData sqCategoryData = (NatureGeneric.CategoryData)this.setCatModData(sqErosionData);
    ...
    public void update(IsoGridSquare square, ErosionData.Square sqErosionData, ErosionCategory.Data data, ErosionData.Chunk chunkData, int eTick) {
        NatureGeneric.CategoryData sqCategoryData = (NatureGeneric.CategoryData)data;
