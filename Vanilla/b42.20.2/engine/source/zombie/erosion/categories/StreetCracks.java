...
public final class StreetCracks extends ErosionCategory {
    ...
    public boolean validateSpawn(
        ...
        StreetCracks.CategoryData sqCategoryData = (StreetCracks.CategoryData)this.setCatModData(sqErosionData);
    ...
    public void update(IsoGridSquare square, ErosionData.Square sqErosionData, ErosionCategory.Data data, ErosionData.Chunk chunkData, int eTick) {
        StreetCracks.CategoryData sqCategoryData = (StreetCracks.CategoryData)data;
