...
public class MigrationGroupDefinitions {
    ...
    public static ArrayList<IsoAnimal> generatePossibleAnimals(VirtualAnimal vAnimal, String type) {
        ...
        if (def == null) {
            DebugType.Animal.debugln("Couldn't find a migration group definition for type: " + type + " check MigrationGroupDefinitions.lua");
            return null;
        }
    ...
    private static ArrayList<IsoAnimal> generatePossibleAnimalsFromGroup(VirtualAnimal vAnimal, MigrationGroupDefinitions def) {
        ...
        if (choosenDef == null) {
            DebugType.Animal.debugln("Couldn't find a migration group definition for type: " + def.type + " check MigrationGroupDefinitions.lua");
            return null;
        } else {
    ...
    public static double getNextEatTime(String animalType) {
        ...
        if (def == null) {
            DebugType.Animal.debugln("Couldn't find a migration group definition for type: " + animalType + " check MigrationGroupDefinitions.lua");
            return 0.0;
        } else {
