...
public final class LowLevelAStar extends AStar {
    ...
    int getSharedEdge(Mesh mesh1, int tri1, Mesh mesh2, int tri2, Vector2f edge1, Vector2f edge2, Vector2f overlap1, Vector2f overlap2) {
        ...
        if (RobustLineIntersector.computeIntersection(p1, p2, p5, p6, overlap1, overlap2) == 2) {
            return this.packEdges(0, 1);
        }

        if (RobustLineIntersector.computeIntersection(p1, p2, p6, p4, overlap1, overlap2) == 2) {
        ...
        if (RobustLineIntersector.computeIntersection(p2, p3, p5, p6, overlap1, overlap2) == 2) {
            return this.packEdges(1, 1);
        }

        if (RobustLineIntersector.computeIntersection(p2, p3, p6, p4, overlap1, overlap2) == 2) {
