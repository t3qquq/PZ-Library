...
public class IsoLivingCharacter extends IsoGameCharacter {
            ...
            if (this.useHandWeapon.getOtherHandRequire() == null
                ...
                if (!this.useHandWeapon.isRanged()) {
                    ...
                    WorldSoundManager.instance
                        .addSound(this, this.getXi(), this.getYi(), this.getZi(), this.useHandWeapon.getSoundRadius(), this.useHandWeapon.getSoundVolume());
                }
    ...
    public boolean isUnarmed() {
        HandWeapon weapon = this.getUseHandWeapon();
        return (weapon == null || weapon == this.bareHands) && !(this.getPrimaryHandItem() instanceof HandWeapon);
    }
