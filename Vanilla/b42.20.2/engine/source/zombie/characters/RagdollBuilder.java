...
public final class RagdollBuilder {
    ...
    public SkinningBone pelvisBone;
    public SkinningBone headBone;
    public SkinningBone leftShoulder;
    public SkinningBone rightShoulder;
    ...
    public boolean Initialize() {
        ...
        this.pelvisBone = this.tPoseAnimationAsset.skinningData.getBone(SkeletonBone.Bip01_Pelvis);
        this.headBone = this.tPoseAnimationAsset.skinningData.getBone(SkeletonBone.Bip01_Head);
        this.leftShoulder = this.tPoseAnimationAsset.skinningData.getBone(SkeletonBone.Bip01_L_UpperArm);
        this.rightShoulder = this.tPoseAnimationAsset.skinningData.getBone(SkeletonBone.Bip01_R_UpperArm);
    ...
    public void initializeRagdollPose() {
        ...
        if (!GameServer.server) {
            ...
            Quaternion localRotation = RagdollController.getRagdollLocalRotation(new Quaternion());
            Bullet.initializeRagdollPose(this.getNumBones(), boneTransformData, localRotation.x, localRotation.y, localRotation.z, localRotation.w);
        }
    }
