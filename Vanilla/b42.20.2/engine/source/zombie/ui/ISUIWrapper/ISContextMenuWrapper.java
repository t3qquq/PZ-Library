...
public class ISContextMenuWrapper extends ISPanelWrapper {
    ...
    public KahluaTable getContextFromOption(String optionName) {
        return this.getOptionFromName(optionName) == null
            ? null
            : (KahluaTable)((KahluaTable)this.table.rawget("instanceMap")).rawget(this.getOptionFromName(optionName).rawget("subOption"));
    }
}
