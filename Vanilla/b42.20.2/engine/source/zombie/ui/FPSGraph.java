...
public final class FPSGraph extends UIElement {
    ...
    private final class Graph {
        private final TLongArrayList times = new TLongArrayList();
        private final BoundedQueue<Long> times2 = new BoundedQueue<>(300);
        private final TIntArrayList bars = new TIntArrayList();
        ...
        public void renderFrameTimes(float r, float g, float b) {
            if (!this.times2.isEmpty()) {
                int barX = 0;
                int numBars = (int)(Core.getInstance().getScreenWidth() - FPSGraph.this.getAbsoluteX() * 2.0) / 8;
