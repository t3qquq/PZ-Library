        ...
        if (this.isVisible()) {
            if (this.parent == null || this.parent.maxDrawHeight == -1 || !(this.parent.maxDrawHeight <= this.y)) {
                ...
                if (this.centerVertically) {
                    yInset = (int)((this.getHeight() - TextManager.instance.MeasureStringY(this.font, this.internalText)) / 2.0);
                }
                ...
                if (this.clearButton && this.clearButtonTexture != null && !this.lines.isEmpty()) {
                    ...
                    this.DrawTextureScaledAspect(
                        ...
                        this.width - xInset - 2.0F - this.clearButtonSize,
                        yInset + (lineHeight - this.clearButtonSize) / 2,
                    ...
                    for (int lineIndex = this.topLineIndex; lineIndex < this.topLineIndex + this.numVisibleLines && lineIndex < this.lines.size(); lineIndex++) {
                        if (this.lines.get(lineIndex) != null) {
                            ...
                            TextManager.instance
                                .DrawString(
                                    this.font,
                                    -this.xOffset + this.getAbsoluteX().intValue() + xInset,
                ...
                if (this.doingTextEntry) {
                    ...
                    if (this.blinkState) {
                        ...
                        this.DrawTextureScaledCol(
                            Texture.getWhite(),
                            -this.xOffset + xInset + textOffset,
                            yInset + this.cursorLine * lineHeight,
                            1.0,
                            lineHeight,
                    ...
                    if (!this.lines.isEmpty() && this.toSelectionIndex != this.textEntryCursorPos) {
                        ...
                        for (int i = line1; i <= line2; i++) {
                            ...
                            this.DrawTextureScaledCol(
                                null, -this.xOffset + xInset + lx, yInset + i * lineHeight, hx - lx, lineHeight, this.textEntryCursorColour2
                            );
                        }
                    }
                    ...
                    TextManager.instance
                        .DrawString(
                            this.font,
                            -this.xOffset + this.getAbsoluteX().intValue() + xInset,
                            this.getAbsoluteY().intValue() + yInset,
