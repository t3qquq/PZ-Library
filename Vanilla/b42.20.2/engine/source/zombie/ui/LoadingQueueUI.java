...
public class LoadingQueueUI extends UIElement {
    ...
    public void render() {
        ...
        TextManager.instance
            .DrawStringCentre(UIFont.Large, this.x + this.width / 2.0F, this.y + 60.0, Translator.getText("UI_GameLoad_LoadingQueue"), 1.0, 1.0, 1.0, 1.0);
        ...
        if (placeInQueue >= 0) {
            TextManager.instance
                .DrawStringCentre(
                    UIFont.Medium, this.x + this.width / 2.0F, this.y + 180.0, Translator.getText("UI_GameLoad_PlaceInQueue", placeInQueue), 1.0, 1.0, 1.0, 1.0
                );
        }
            ...
            try {
                    ...
                    if (zombieKilledToday == 0) {
                        ...
                        TextManager.instance
                            .DrawStringCentre(
                                ...
                                this.x + this.width / 2.0F,
                                this.y + y2,
                                Translator.getText("UI_GameLoad_zombieKilledTodayN", zombieKilledToday),
                                1.0,
                                1.0,
                                1.0,
                                IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state1)
                    ...
                    if (zombifiedPlayersToday == 0) {
                        ...
                        TextManager.instance
                            .DrawStringCentre(
                                ...
                                this.x + this.width / 2.0F,
                                this.y + y2,
                                Translator.getText("UI_GameLoad_zombifiedPlayersTodayN", zombifiedPlayersToday),
                                1.0,
                                1.0,
                                1.0,
                                IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state1)
                    ...
                    if (burnedZombiesToday == 0) {
                        ...
                        TextManager.instance
                            .DrawStringCentre(
                                ...
                                this.x + this.width / 2.0F,
                                this.y + y2,
                                Translator.getText("UI_GameLoad_burnedZombiesTodayN", burnedZombiesToday),
                                1.0,
                                1.0,
                                1.0,
                                IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state1)
                ...
                if (state2 > 0.0F) {
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            this.x + this.width / 2.0F,
                            this.y + y2,
                            Translator.getText("UI_GameLoad_time", timeHour, timeMinute),
                            1.0,
                            1.0,
                            1.0,
                            IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state2)
                        );
                    y2 += 30;
                    stageStep1 += 0.1F;
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            this.x + this.width / 2.0F,
                            this.y + y2,
                            String.format("%d/%d/%d", serverInformation.get("Year"), serverInformation.get("Month"), serverInformation.get("Day")),
                            1.0,
                            1.0,
                            1.0,
                            IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state2)
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            this.x + this.width / 2.0F,
                            this.y + y2,
                            Translator.getText("UI_GameLoad_temperature", "%.1f".formatted(serverInformation.get("Temperature"))),
                            1.0,
                            1.0,
                            1.0,
                            IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state2)
                    ...
                    TextManager.instance
                        .DrawStringCentre(
                            ...
                            this.x + this.width / 2.0F,
                            this.y + y2,
                            Translator.getText("UI_GameLoad_humidity", "%.1f".formatted((Float)serverInformation.get("Humidity") * 100.0F)),
                            1.0,
                            1.0,
                            1.0,
                            IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state2)
                ...
                if (state3 > 0.0F) {
                    ...
                    this.DrawTextureScaled(
                        ...
                        100.0,
                        100.0,
                        IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state3)
                    );
                    y2 += 130;
                    stageStep1 += 0.1F;
                    TextManager.instance
                ...
                if (state4 > 0.0F) {
                    ...
                    this.DrawTextureScaled(
                        ...
                        100.0,
                        100.0,
                        IsoUtils.smoothstep(stageStep1 - 0.2F, stageStep1, state4)
                    );
                    stageStep1 += 0.1F;
                    TextManager.instance
                        .DrawStringCentre(
                ...
                DebugType.General.printException(e, "LoadingQueueUI render failed", LogSeverity.Error);
            }
        }
    }
