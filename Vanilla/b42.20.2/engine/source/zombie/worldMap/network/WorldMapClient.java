...
public final class WorldMapClient {
    ...
    private void receiveAddSymbol(ByteBufferReader bb) throws IOException {
        if (this.receivedRequestData) {
            ...
            WorldMapBaseSymbol symbol = switch ((WorldMapSymbols.WorldMapSymbolType)bb.getEnum(WorldMapSymbols.WorldMapSymbolType.class)) {
                ...
                case Text -> new WorldMapTextSymbol(MapItem.getSingleton().getSymbols());
                case Texture -> new WorldMapTextureSymbol(MapItem.getSingleton().getSymbols());
            };
    ...
    public void worldMapLoaded() {
        ...
        HiddenAuthors.clearLocal();
        PlayerVisitedPacket.requestInitialData();
    ...
    public void setAuthorHidden(String userName, boolean hidden) {
        HiddenAuthors.setAuthorHidden(userName, hidden);
    }

    public boolean isAuthorHidden(String userName) {
        return HiddenAuthors.isAuthorHidden(userName);
    }
