...
public final class WorldMapStreet {
    static final ObjectPool<WorldMapStreet> s_pool = new ObjectPool<>(WorldMapStreet::new, "WorldMapStreet.s_pool");
    static final ObjectPool<StreetPoints> s_pointsPool = new ObjectPool<>(StreetPoints::new, "WorldMapStreet.s_pointsPool");
    ...
    static final ObjectPool<CharLayout> s_charLayoutPool = new ObjectPool<>(CharLayout::new, "WorldMapStreet.s_charLayoutPool");
