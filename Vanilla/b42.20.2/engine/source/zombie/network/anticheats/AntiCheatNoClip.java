...
public class AntiCheatNoClip extends AbstractAntiCheat {
    ...
    public void react(UdpConnection connection, INetworkPacket packet) {
        ...
        if ((!connection.getRole().hasCapability(Capability.ToggleNoclipHimself) || !player.isNoClip())
            && (!connection.getRole().hasCapability(Capability.UseFastMoveCheat) || !player.isFastMoveCheat())) {
    ...
    public String validate(UdpConnection connection, INetworkPacket packet) {
        ...
        if (field.validateHitVehicleDistance()) {
            return result;
        }
    ...
    public interface IAntiCheat {
        ...
        boolean validateHitVehicleDistance();
    }
}
