                    ...
                    for (int x = 0; x < IsoChunkMap.chunkGridWidth; x++) {
                        ...
                        if (chunk != null) {
                            ...
                            if (loaded && tex != null) {
                                ...
                                IsoChunk chunkS = chunkMap.getChunk(x, y + 1);
                                if (chunkS != null && !isLoaded[x + (y + 1) * IsoChunkMap.chunkGridWidth]) {
                                    for (int xx = 0; xx < 8; xx++) {
                                ...
                                IsoChunk chunkW = chunkMap.getChunk(x - 1, y);
                                if (chunkW != null && !isLoaded[x - 1 + y * IsoChunkMap.chunkGridWidth]) {
                                ...
                                IsoChunk chunkE = chunkMap.getChunk(x + 1, y);
                                if (chunkE != null && !isLoaded[x + 1 + y * IsoChunkMap.chunkGridWidth]) {
                                    for (int yy = 0; yy < 8; yy++) {
