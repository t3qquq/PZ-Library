...
public class RemoveItemFromSquarePacket implements INetworkPacket {
        ...
        if (IsoWorld.instance.currentCell != null) {
            ...
            if (sq == null) {
                ...
                if (this.index >= 0 && this.index < sq.getObjects().size()) {
                    ...
                    boolean isDestroyAsMultiTileObject = o.hasProperty(IsoPropertyType.GARAGE_DOOR) || o.hasProperty(IsoPropertyType.DOUBLE_DOOR);
                    sq.RemoveTileObject(o, isDestroyAsMultiTileObject);
    ...
    public static void removeItemFromMap(UdpConnection connection, int x, int y, int z, int index) {
        ...
        if (sq != null && index >= 0 && index < sq.getObjects().size()) {
            ...
            if (o instanceof IsoWorldInventoryObject isoWorldInventoryObject) {
                ...
                if (connection != null) {
                    LoggerManager.getLogger("map")
                        .write(connection.getIDStr() + " \"" + connection.getUserName() + "\" removed " + name + " at " + x + "," + y + "," + z);
                }
            }
            ...
            if (o.hasProperty(IsoPropertyType.GARAGE_DOOR) || o.hasProperty(IsoPropertyType.DOUBLE_DOOR)) {
                sq.RemoveTileObject(o, true);
            }
