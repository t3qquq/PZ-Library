...
public class SyncExtendedPlacementPacket implements INetworkPacket {
    ...
    private void updateObject(IsoWorldInventoryObject object) {
        if (object == null) {
            DebugType.Multiplayer.noise("[SyncExtendedPlacementPacket] skipping update of null IsoWorldInventoryObject");
        } else {
    ...
    private void findObject() {
        ...
        if (this.gridSquare == null) {
            DebugType.Multiplayer.warn("[SyncExtendedPlacementPacket] parse error: gridSquare is null x,y,z=" + this.x + "," + this.y + "," + this.z);
        } else {
            this.object = this.getIsoWorldInventoryObjectWithID();
            if (this.object == null) {
                DebugType.Multiplayer.noise("[SyncExtendedPlacementPacket] unable to find object for gridSquare x,y,z=" + this.x + "," + this.y + "," + this.z);
            }
        }
    }
}
