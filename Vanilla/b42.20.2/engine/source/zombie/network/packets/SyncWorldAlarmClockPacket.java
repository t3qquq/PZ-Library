...
public class SyncWorldAlarmClockPacket implements INetworkPacket {
    ...
    private void findAlarmClockWorld() {
        ...
        if (this.gridSquare == null) {
            DebugType.Multiplayer.warn("[SyncAlarmClock] parse error: gridSquare is null x,y,z=" + this.x + "," + this.y + "," + this.z);
        } else {
            ...
            if (wo != null && wo.getItem() instanceof IAlarmClock) {
                ...
                DebugType.Multiplayer.noise("[SyncAlarmClock] unable to find alarmClock for gridSquare x,y,z=" + this.x + "," + this.y + "," + this.z);
            }
        }
    }
