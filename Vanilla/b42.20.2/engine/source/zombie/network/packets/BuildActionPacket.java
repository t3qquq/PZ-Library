    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        if (this.state == Transaction.TransactionState.Request) {
            if (this.isConsistent(connection) && this.item != null) {
                DebugType.Action.trace("BuildAction accepted %s", this.getDescription());
                ...
                DebugType.Action.trace("BuildAction rejected %s", this.getDescription());
            ...
            DebugType.Action.trace("BuildAction reject %s", this.getDescription());
