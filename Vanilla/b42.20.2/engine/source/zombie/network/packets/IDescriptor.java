...
public interface IDescriptor {
            ...
            if (annotations.length > 0) {
                ...
                try {
                    ...
                    DebugType.Multiplayer
                        .printException(e, "INetworkPacketField.getDescription: can't get the value of the " + name + " field", LogSeverity.Error);
                }
            }
        }
    }
    ...
    private String toJSON(Object obj, HashSet<Object> excludedObjects) {
        ...
        if (obj instanceof INetworkPacketField iNetworkPacketField) {
