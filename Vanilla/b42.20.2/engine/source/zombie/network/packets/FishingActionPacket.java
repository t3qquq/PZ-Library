...
public class FishingActionPacket extends FishingAction implements INetworkPacket {
    ...
    public void setData(Object... values) {
        DebugType.Objects.warn("The FishingActionPacket.setData function isn't implemented");
        DebugType.Objects.printStackTrace();
    }
    ...
    public void processClient(UdpConnection connection) {
        ...
        if ((this.contentFlag & (flagUpdateFish | flagDestroyBobber | flagCreateBobber)) != 0) {
            ...
            if (data != null) {
                ...
                DebugType.Objects.warn("FishingActionPacket.processClient: no data found");
            }
        }
    }
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        if (this.state == Transaction.TransactionState.Request) {
            if (this.isConsistent(connection)) {
                DebugType.Action.trace("FishingAction accepted %s", this.getDescription());
                ...
                DebugType.Action.trace("FishingAction rejected %s", this.getDescription());
            ...
            DebugType.Action.trace("FishingAction reject %s", this.getDescription());
        ...
        if ((this.contentFlag & flagUpdateBobberParameters) != 0) {
            ...
            if (data != null) {
                ...
                DebugType.Objects.warn("FishingActionPacket.processServer: no data found");
            }
        }
    }
}
