...
public class ServerSettings {
    ...
    public ServerSettings(String name) {
        String nameSanitized = FileName.sanitize(name);
        ZomboidFileSystem.instance.validatePrefix(nameSanitized);
        this.name = nameSanitized;
        String error = ProfanityFilter.getInstance().validateString(nameSanitized, true, true, true);
    ...
    public boolean duplicateFiles(String newName) {
        ...
        copy.name = FileName.sanitize(newName);
        copy.saveFiles();
        return true;
    }
    ...
    public boolean rename(String newName) {
        ...
        this.name = FileName.sanitize(newName);
        this.saveFiles();
        return true;
    }
