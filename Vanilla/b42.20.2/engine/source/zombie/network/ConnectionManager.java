...
public class ConnectionManager {
    ...
    public static void log(String event, String message, long guid) {
        LoggerManager.getLogger("connections").write("event=\"" + event + "\" message=\"" + message + "\" guid=\"" + guid + "\"");
    }

    public static void log(String event, String message, IConnection connection) {
        if (connection == null) {
            log(event, message, 0L);
        } else {
            LoggerManager.getLogger("connections").write("event=\"" + event + "\" message=\"" + message + "\" " + connection.getDescription());
        }
    }
