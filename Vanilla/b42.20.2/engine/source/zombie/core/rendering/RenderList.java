    ...
    private abstract static class BaseDrawList {
        ...
        protected void DrawInstanced() {
            ...
            while (counter < totalCount) {
                ...
                try (GameProfiler.ProfileArea at = profiler.profile("Push Data")) {
                ...
                try (GameProfiler.ProfileArea var11 = profiler.profile("Copy Textures")) {
                    CopyTextures(at);
                }
                ...
                try (GameProfiler.ProfileArea var24 = profiler.profile("Update Instanced")) {
                    this.UpdateData();
                }

                try (GameProfiler.ProfileArea var25 = profiler.profile("Draw Instanced")) {
        ...
        protected final void PushData(int counter, int end) {
            while (counter < end) {
                ...
                try (GameProfiler.ProfileArea var7 = profiler.profile("Update Properties")) {
                    this.UpdateProperties(counter);
                }

                try (GameProfiler.ProfileArea var15 = profiler.profile("Write to Buffer")) {
