...
public final class Colors {
    private static final HashMap<String, Colors.ColNfo> infoMap = new HashMap<>();
    private static final ArrayList<Colors.ColNfo> infoList = new ArrayList<>();
    ...
    private static final HashMap<String, Colors.ColNfo> CB_infoMap = new HashMap<>();
    ...
    public static final Color CB_White = addColorCB("White", new Color(1.0F, 1.0F, 1.0F));
    ...
    private static Color addColor(String name, Color color) {
        Colors.ColNfo nfo = new Colors.ColNfo(name, color, Colors.ColorSet.Standard);
    ...
    public static Color AddGameColor(String name, Color color) {
        if (infoMap.containsKey(name)) {
            Colors.ColNfo nfo = infoMap.get(name);
            if (nfo.colorSet == Colors.ColorSet.Game) {
                nfo.color.set(color);
                return color;
            }
        }

        Colors.ColNfo nfo = new Colors.ColNfo(name, color, Colors.ColorSet.Game);
        infoMap.put(name, nfo);
        infoList.add(nfo);
        colorMap.put(name.toLowerCase(), color);
        colorNames.add(name);
    ...
    public static Colors.ColNfo GetColorInfo(String name) {
        return infoMap.get(name);
    }

    public static String getNameFromColor(Color color) {
        for (Colors.ColNfo col : infoMap.values()) {
            if (col.color == color) {
                return col.name;
            }
        }
    ...
    private static Color addColorCB(String name, Color color) {
        Colors.ColNfo nfo = new Colors.ColNfo(name, color, Colors.ColorSet.ColorBlind);
        infoList.add(nfo);
    ...
    public static class ColNfo {
        private final Colors.ColorSet colorSet;
        ...
        public ColNfo(String name, Color c, Colors.ColorSet colorSet) {
