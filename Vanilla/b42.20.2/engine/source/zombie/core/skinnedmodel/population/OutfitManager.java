...
public class OutfitManager {
                ...
                if (outfitManager != null) {
                    for (Outfit outfitMod : outfitManager.maleOutfits) {
                        ...
                        if (outfit == null) {
                            ...
                            DebugType.Clothing.println("mod \"%s\" overrides male outfit \"%s\"", modID, outfitMod.name);
                    ...
                    for (Outfit outfitMod : outfitManager.femaleOutfits) {
                        ...
                        if (outfit == null) {
                            ...
                            DebugType.Clothing.println("mod \"%s\" overrides female outfit \"%s\"", modID, outfitMod.name);
    ...
    private static void onClothingXmlFileChanged() {
        DebugType.Clothing.println("OutfitManager.onClothingXmlFileChanged> Detected change in media/clothing/clothing.xml");
        Reload();
    }

    public static void Reload() {
        DebugType.Clothing.println("Reloading OutfitManager");
    ...
    public ClothingItem getClothingItem(String itemGUID) {
        ...
        if (cachedElement.fileWatcher == null) {
            OutfitManager.ClothingItemEntry cachedElement2 = cachedElement;
            String filePath1 = cachedElement2.filePath;
            filePath1 = ZomboidFileSystem.instance.getString(filePath1);
            cachedElement.fileWatcher = new PredicatedFileWatcher(filePath1, entryKey -> this.onClothingItemFileChanged(cachedElement2));
    ...
    private String extractClothingItemName(String filePath) {
        ...
        itemName = StringUtils.trimPrefix(itemName, "media/clothing/clothingItems/");
                ...
                if (itemType != null) {
                    ...
                    if (scriptItem != null && scriptItem.isItemType(ItemType.CONTAINER)) {
                        ...
                        if (bagLocation != null && bagLocation.equals(location)) {
                            DebugType.Clothing.warn("outfit \"%s\" has multiple bags", outfit.name);
                        }
