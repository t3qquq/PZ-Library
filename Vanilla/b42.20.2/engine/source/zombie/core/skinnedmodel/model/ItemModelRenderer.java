...
public final class ItemModelRenderer {
    private static final ObjectPool<ItemModelRenderer.WeaponPartParams> s_weaponPartParamPool = new ObjectPool<>(
        ItemModelRenderer.WeaponPartParams::new, "ItemModelRenderer.s_weaponPartParamPool"
    );
    ...
    private boolean checkSmartTexture(String modelTextureName) {
        ...
        if (bUseSmartTexture) {
            ...
            if (this.bloodLevel > 0.0F) {
                this.smartTexture
                    .setBlood(
                        "media/textures/BloodTextures/BloodOverlayWeapon.png", "media/textures/BloodTextures/BloodOverlayWeaponMask.png", this.bloodLevel, 301
                    );
            }
