...
public final class SharedVertexBufferObjects {
    ...
    public SharedVertexBufferObjects(int bytesPerVertex) {
        this.bufferSizeVertices = 65536 / bytesPerVertex;
        this.indexBufferSizeBytes = this.bufferSizeVertices * 3;
    }

    public void startFrame() {
        boolean assumePreviousFrameRendered = true;
        this.sequence = -1;
    ...
    public void next() {
        ...
        if (this.sequence == this.mark) {
            DebugType.General.error("SharedVertexBufferObject overrun.");
        }
