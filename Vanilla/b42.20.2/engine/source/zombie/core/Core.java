...
public final class Core {
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "ffe7a8a4b1";
        }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "ffe7a8a4b1".substring(0, Math.min("ffe7a8a4b1".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "ffe7a8a4b1";
    }
