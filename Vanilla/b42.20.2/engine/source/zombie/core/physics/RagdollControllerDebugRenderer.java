...
public class RagdollControllerDebugRenderer {
    ...
    public static void drawIsoDebug(
        ...
        drawIsoPerspectiveSquare(
            new Vector3(gameCharacterObject.getX(), gameCharacterObject.getY(), gameCharacterObject.getZ()),
            0.15F,
            0.15F,
            0.15F,
            0.015F,
        ...
        drawIsoPerspectiveSquare(characterPosition, 0.15F, 0.15F, 0.15F, 0.015F, forward, perp, characterPosColor, 0.5F);
