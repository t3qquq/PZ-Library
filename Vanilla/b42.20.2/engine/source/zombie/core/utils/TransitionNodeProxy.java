...
public final class TransitionNodeProxy {
    ...
    private static final ObjectPool<TransitionNodeProxy.NodeLayerPair> s_nodeLayerPairPool = new ObjectPool<>(
        TransitionNodeProxy.NodeLayerPair::new, "TransitionNodeProxy.s_nodeLayerPairPool"
    );
    private static final ObjectPool<TransitionNodeProxy.TransitionNodeProxyData> s_transitionNodeProxyDataPool = new ObjectPool<>(
        TransitionNodeProxy.TransitionNodeProxyData::new, "TransitionNodeProxy.s_transitionNodeProxyDataPool"
    );
    ...
    public TransitionNodeProxy.NodeLayerPair allocNodeLayerPair(LiveAnimNode liveAnimNode, AnimLayer animLayer) {
    ...
    public static class NodeLayerPair {
        ...
        public TransitionNodeProxy.NodeLayerPair set(LiveAnimNode liveAnimNode, AnimLayer animLayer) {
