...
public class TradingManager {
    ...
    private final List<TradingManager.Trading> tradings = new ArrayList<>();
    private final List<TradingManager.Trading> finalisingTradings = new ArrayList<>();
    private final List<TradingManager.Trading> finalisedTradings = new ArrayList<>();
    ...
    public void removeItem(IsoPlayer player, int itemId) {
        for (TradingManager.Trading t : this.tradings) {
            ...
            if (t.playerB == player) {
                t.playerBItems.removeIf(i -> i.getID() == itemId);
                break;
            }
        }
    }
    ...
    private static final class Trading {
        long time;
        final IsoPlayer playerA;
        final IsoPlayer playerB;
        final List<InventoryItem> playerAItems = new ArrayList<>();
        final List<InventoryItem> playerBItems = new ArrayList<>();
        boolean playerAAgreement;
        boolean playerBAgreement;

        public Trading(IsoPlayer playerA, IsoPlayer playerB) {
