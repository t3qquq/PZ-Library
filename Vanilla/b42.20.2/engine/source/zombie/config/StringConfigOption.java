...
public class StringConfigOption extends ConfigOption {
    ...
    public StringConfigOption(String name, String defaultValue, ConfigOption.ConfigOptionOnChangeCallback onChange) {
        super(name);
        if (defaultValue == null) {
            defaultValue = "";
        }
    ...
    public void setValueFromObject(Object o) {
        if (this.values != null) {
            ...
            DebugType.General.println("ERROR: StringConfigOption.setValueFromObject() \"%s\" value \"%s\" is unknown", this.getName(), o);
        } else {
            if (o == null) {
    ...
    public void setValue(String value) {
        if (this.values != null) {
            if (this.isValidString(value)) {
                ...
                DebugType.General.println("ERROR StringConfigOption.setValue() \"%s\" string=\"%s\"", this.getName(), value);
            }
        } else {
            if (value == null) {
                value = "";
