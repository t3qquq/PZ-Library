...
public final class ConnectToServerState extends GameState {
    ...
    public GameStateMachine.StateAction update() {
        try {
            ...
            DebugType.General.printException(e, LogSeverity.Error, "StateAction Exception thrown. Handled gracefully, returning StateAction.Continue");
            return GameStateMachine.StateAction.Continue;
        }
    }
    ...
    private void CheckMods() {
        ...
        Map<String, String> modIdToWorkshopId = new HashMap<>();
        Map<String, String> modIdToModName = new HashMap<>();
    ...
    private void Finish() {
        ...
        try {
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveStartLocation error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveServerOptions error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveSandboxOptions error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveGameTime error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveErosionMain error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveGlobalObjects error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveResetID error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveBerries error", LogSeverity.Error);
                throw e;
            }
            ...
            try {
                ...
                DebugType.Multiplayer.printException(e, "receiveWorldDictionary error", LogSeverity.Error);
                throw e;
            }
        } catch (Exception e) {
