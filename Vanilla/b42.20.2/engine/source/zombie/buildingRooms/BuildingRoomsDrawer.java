...
public final class BuildingRoomsDrawer extends TextureDraw.GenericDrawer {
    ...
    void renderRect(
        ...
        float depth0 = IsoDepthHelper.getSquareDepthData(PZMath.fastfloor(playerX), PZMath.fastfloor(playerY), x1, y1, level).depthStart + depthAdjust;
        float depth1 = IsoDepthHelper.getSquareDepthData(PZMath.fastfloor(playerX), PZMath.fastfloor(playerY), x2, y1, level).depthStart + depthAdjust;
        float depth2 = IsoDepthHelper.getSquareDepthData(PZMath.fastfloor(playerX), PZMath.fastfloor(playerY), x2, y2, level).depthStart + depthAdjust;
        float depth3 = IsoDepthHelper.getSquareDepthData(PZMath.fastfloor(playerX), PZMath.fastfloor(playerY), x1, y2, level).depthStart + depthAdjust;
