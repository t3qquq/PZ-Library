...
public class CollideWithObstaclesPoly {
    ...
    public Vector2f resolveCollision(IsoGameCharacter chr, float nx, float ny, Vector2f finalPos) {
        ...
        if (closestEdge == null) {
            ...
            for (int i = 0; i < this.obstacles.size(); i++) {
                CollideWithObstaclesPoly.CCObstacle obstacle1 = this.obstacles.get(i);
        ...
        if (nodeAtXY != null) {
            ...
            for (int i = 0; i < nodeAtXY.edges.size(); i++) {
                CollideWithObstaclesPoly.CCEdge edge = nodeAtXY.edges.get(i);
                if (edge != closestEdge
    ...
    private static final class CCEdge {
        ...
        private static final ObjectPool<CollideWithObstaclesPoly.CCEdge> pool = new ObjectPool<>(CollideWithObstaclesPoly.CCEdge::new, "CCEdge.pool");
    ...
    private static final class CCEdgeRing extends ArrayList<CollideWithObstaclesPoly.CCEdge> {
        private static final ObjectPool<CollideWithObstaclesPoly.CCEdgeRing> pool = new ObjectPool<CollideWithObstaclesPoly.CCEdgeRing>(
            CollideWithObstaclesPoly.CCEdgeRing::new, "CCEdgeRing.pool"
        ) {
    ...
    private static final class CCNode {
        ...
        private static final ObjectPool<CollideWithObstaclesPoly.CCNode> pool = new ObjectPool<>(CollideWithObstaclesPoly.CCNode::new, "CCNode.pool");
    ...
    private static final class CCObstacle {
        ...
        private static final ObjectPool<CollideWithObstaclesPoly.CCObstacle> pool = new ObjectPool<CollideWithObstaclesPoly.CCObstacle>(
            CollideWithObstaclesPoly.CCObstacle::new, "CCObstacle.pool"
        ) {
    ...
    public static final class ChunkDataZ {
        ...
        public int z;
        public static final ObjectPool<CollideWithObstaclesPoly.ChunkDataZ> pool = new ObjectPool<>(CollideWithObstaclesPoly.ChunkDataZ::new, "ChunkDataZ.pool");
        ...
        public void init(IsoChunk chunk, int z, CollideWithObstaclesPoly instance) {
            ...
            x2 += 2;
            y2 += 2;
            CollideWithObstaclesPoly.ImmutableRectF chunkBounds = instance.moveBounds.init(x1, y1, x2 - x1, y2 - y1);
