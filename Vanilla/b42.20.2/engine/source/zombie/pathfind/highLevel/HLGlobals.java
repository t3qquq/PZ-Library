...
public final class HLGlobals {
    static final ObjectPool<HLChunkRegion> chunkRegionPool = new ObjectPool<>(HLChunkRegion::new, "HLGlobals.chunkRegionPool");
    static final ObjectPool<HLStaircase> staircasePool = new ObjectPool<>(HLStaircase::new, "HLGlobals.staircasePool");
    static final ObjectPool<HLSlopedSurface> slopedSurfacePool = new ObjectPool<>(HLSlopedSurface::new, "HLGlobals.slopedSurfacePool");
    static final ObjectPool<HLSuccessor> successorPool = new ObjectPool<>(HLSuccessor::new, "HLGlobals.successorPool");
    ...
    static final ObjectPool<HLSearchNode> searchNodePool = new ObjectPool<>(HLSearchNode::new, "HLGlobals.searchNodePool");
