        ...
        if (this.square != null) {
            for (int dy = -1; dy <= 1; dy++) {
                for (int dx = -1; dx <= 1; dx++) {
                    if (dx != 0 || dy != 0) {
                        Square square1 = PolygonalMap2.instance.getSquareRawZ(this.square.x + dx, this.square.y + dy, this.square.z);
                        if (square1 != null
                            && this.astar.mover.isAllowedChunkLevel(square1)
                            && (!this.astar.isSquareInCluster(square1) || square1.has(504))
                            && this.astar.canMoveBetween(this.square, square1, false)) {
                            SearchNode searchNode = this.astar.getSearchNode(square1);
                            if (successors.contains(searchNode)) {
                                boolean var6 = false;
                            } else {
            ...
            if (this.square.has(288)) {
                ...
                Square square1 = this.square.getAdjacentSquare(dir.Rot180());
                if (square1 != null
                    && PolygonalMap2.instance.getExistingNodeForSquare(square1) != null
                    && PolygonalMap2.instance.getExistingNodeForSquare(square1).hasFlag(16)
                    && this.astar.mover.isAllowedChunkLevel(square1)
                    && this.astar.canMoveBetween(this.square, square1, false)) {
                    SearchNode searchNode = this.astar.getSearchNode(square1);
                    if (successors.contains(searchNode)) {
            ...
            if (this.square.z > this.astar.mover.minLevel) {
                Square square1 = PolygonalMap2.instance.getSquare(this.square.x, this.square.y + 1, this.square.z - 1);
                if (square1 != null
                    && square1.hasTransitionToLevelAbove(IsoDirections.N)
                ...
                square1 = PolygonalMap2.instance.getSquare(this.square.x, this.square.y - 1, this.square.z - 1);
                if (square1 != null
                    && square1.hasTransitionToLevelAbove(IsoDirections.S)
                    && !this.astar.isSquareInCluster(square1)
                ...
                if (square1 != null
                    && square1.hasTransitionToLevelAbove(IsoDirections.W)
                    && !this.astar.isSquareInCluster(square1)
                ...
                square1 = PolygonalMap2.instance.getSquare(this.square.x - 1, this.square.y, this.square.z - 1);
                if (square1 != null
                    && square1.hasTransitionToLevelAbove(IsoDirections.E)
                    && !this.astar.isSquareInCluster(square1)
            ...
            if (this.square.z < this.astar.mover.maxLevel) {
                if (this.square.hasTransitionToLevelAbove(IsoDirections.N)) {
                    Square square1 = PolygonalMap2.instance.getSquareRawZ(this.square.x, this.square.y - 1, this.square.z + 1);
                    if (square1 != null && !this.astar.isSquareInCluster(square1) && this.astar.mover.isAllowedLevelTransition(IsoDirections.N, square1, true)) {
                        SearchNode searchNode = this.astar.getSearchNode(square1);
                        if (successors.contains(searchNode)) {
                            boolean var37 = false;
                        } else {
                ...
                if (this.square.hasTransitionToLevelAbove(IsoDirections.S)) {
                    Square square1 = PolygonalMap2.instance.getSquareRawZ(this.square.x, this.square.y + 1, this.square.z + 1);
                    if (square1 != null && !this.astar.isSquareInCluster(square1) && this.astar.mover.isAllowedLevelTransition(IsoDirections.S, square1, true)) {
                        SearchNode searchNode = this.astar.getSearchNode(square1);
                        if (successors.contains(searchNode)) {
                            boolean var38 = false;
                        } else {
                ...
                if (this.square.hasTransitionToLevelAbove(IsoDirections.W)) {
                    Square square1 = PolygonalMap2.instance.getSquareRawZ(this.square.x - 1, this.square.y, this.square.z + 1);
                    if (square1 != null && !this.astar.isSquareInCluster(square1) && this.astar.mover.isAllowedLevelTransition(IsoDirections.W, square1, true)) {
                        SearchNode searchNode = this.astar.getSearchNode(square1);
                        if (successors.contains(searchNode)) {
                            boolean var39 = false;
                        } else {
                ...
                if (this.square.hasTransitionToLevelAbove(IsoDirections.E)) {
                    Square square1 = PolygonalMap2.instance.getSquareRawZ(this.square.x + 1, this.square.y, this.square.z + 1);
                    if (square1 != null && !this.astar.isSquareInCluster(square1) && this.astar.mover.isAllowedLevelTransition(IsoDirections.E, square1, true)) {
                        SearchNode searchNode = this.astar.getSearchNode(square1);
                        if (successors.contains(searchNode)) {
                            boolean var40 = false;
                        } else {
