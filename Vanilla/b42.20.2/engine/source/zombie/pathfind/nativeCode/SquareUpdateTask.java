...
class SquareUpdateTask implements IPathfindTask {
    ...
    private static final ObjectPool<SquareUpdateTask> pool = new ObjectPool<>(SquareUpdateTask::new, "SquareUpdateTask.pool");
    ...
    private static boolean canClimbDownSheetRope(IsoGridSquare sq) {
        ...
        while (sq != null) {
            ...
            sq = IsoWorld.instance.currentCell.getGridSquare(sq.getX(), sq.getY(), sq.getZ() - 1.0F);
        }
