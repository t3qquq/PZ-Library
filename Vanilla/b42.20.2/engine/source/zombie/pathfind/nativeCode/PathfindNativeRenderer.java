        ...
        public void render() {
            if (PathfindNativeThread.instance != null) {
                synchronized (PathfindNativeThread.instance.renderLock) {
                    ...
                    PathfindNativeRenderer.instance
                        .setDebugOption(DebugOptions.instance.pathfindRenderClusters.getName(), DebugOptions.instance.pathfindRenderClusters.getValueAsString());
                    PathfindNativeRenderer.instance
                        .setDebugOption(
                            DebugOptions.instance.pathfindRenderConnections.getName(), DebugOptions.instance.pathfindRenderConnections.getValueAsString()
                        );
                    PathfindNativeRenderer.instance
                        .setDebugOption(DebugOptions.instance.pathfindRenderCrawling.getName(), DebugOptions.instance.pathfindRenderCrawling.getValueAsString());
                    PathfindNativeRenderer.instance
                        .setDebugOption(DebugOptions.instance.pathfindRenderNodes.getName(), DebugOptions.instance.pathfindRenderNodes.getValueAsString());
