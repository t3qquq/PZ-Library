...
public class RangeWeaponPanel extends PZDebugWindow {
    ...
    private enum RangeWeaponAttribute {
        ...
        RangeWeaponAttribute(final String id, final double min, final double max, final double defaultValue) {
            this.id = id;
            this.min = min;
            this.max = max;
    ...
    public class RangeWeaponsConfigOptions {
        ...
        private final ArrayList<RangeWeaponPanel.RangeWeaponsConfigOption> options = new ArrayList<>();
