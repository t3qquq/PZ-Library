...
import zombie.SlowMotionMultiplier;
...
public final class DebugOptions implements IDebugOptionGroup {
    ...
    public final BooleanDebugOption joypadRenderUiNavigation = this.newDebugOnlyOption("Joypad.Render.UINavigation", false);
    ...
    public final BooleanDebugOption pathfindRenderClusters = this.newOption("Pathfind.Render.Clusters", false);
    public final BooleanDebugOption pathfindRenderConnections = this.newOption("Pathfind.Render.Connections", false);
    public final BooleanDebugOption pathfindRenderCrawling = this.newOption("Pathfind.Render.Crawling", false);
    public final BooleanDebugOption pathfindRenderLineClearCollide = this.newOption("Pathfind.Render.LineClearCollide", false);
    public final BooleanDebugOption pathfindRenderNodes = this.newOption("Pathfind.Render.Nodes", false);
    ...
    public final BooleanDebugOption vehicleRenderVelocity = this.newDebugOnlyOption("Vehicle.Render.Velocity", false);
    ...
    public final BooleanDebugOption zombieVocalsRender = this.newDebugOnlyOption("Sound.ZombieVocals.Render", false);
    ...
    public final BooleanDebugOption zombieRenderThump = this.newDebugOnlyOption("Zombie.Render.Thump", false);
    ...
    public final BooleanDebugOption renderTreeSeen = this.newOption("Rendering.TreeSeen", false);
    ...
    public SlowMotionMultiplier getSlowMotionMultiplier() {
        SlowMotionMultiplier multiplier = SlowMotionMultiplier.ONE;
        if (instance.gameTimeSpeedHalf.getValue()) {
            multiplier = multiplier.getHalfOf();
        }

        if (instance.gameTimeSpeedQuarter.getValue()) {
            multiplier = multiplier.getQuarterOf();
        }

        if (instance.gameTimeSpeedEighth.getValue()) {
            multiplier = multiplier.getEighthOf();
        }
