...
require "Vehicles/VehicleDistributions"
	...
	if (SandboxVars.A26.BoolSkipRemovals == false) then
		-----------------------------------------------------
		---------------------- PRIMARY ----------------------
		-----------------------------------------------------
		...
		RemoveItemFromDistribution(SuburbsDistributions, "ShotgunCase1",		nil, true);
		RemoveItemFromDistribution(SuburbsDistributions, "ShotgunCase2",		nil, true);
		RemoveItemFromDistribution(SuburbsDistributions, "RifleCase1",		nil, true);
		RemoveItemFromDistribution(SuburbsDistributions, "RifleCase2",		nil, true);
		RemoveItemFromDistribution(SuburbsDistributions, "RifleCase3",		nil, true);
		...
		RemoveItemFromDistribution(VehicleDistributions, "AmmoStrap_Bullets",	nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "AmmoStrap_Shells",	nil, true);
		...
		RemoveItemFromDistribution(VehicleDistributions, "ShotgunCase1",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "ShotgunCase2",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "RifleCase1",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "RifleCase2",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "RifleCase3",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions, "M14Clip",		nil, true);
		...
		RemoveItemFromDistribution(VehicleDistributions.Police, "Vest_BulletPolice",	nil, true);
		RemoveItemFromDistribution(VehicleDistributions.Police, "HandTorch",	nil, true);				-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "Hat_EarMuff_Protectors",	nil, true);	-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "GunPowder",		nil, true);
		RemoveItemFromDistribution(VehicleDistributions.Police, "Nightstick",		nil, true);			-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "Bullets9mmBox",		nil, true);		-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "308Box",		nil, true);				-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "223Box",		nil, true);				-- BAG_POLICE
		RemoveItemFromDistribution(VehicleDistributions.Police, "ShotgunShellsBox",		nil, true);		-- BAG_POLICE
		...
		RemoveItemFromDistribution(ProceduralDistributions.list, "ShotgunCase1",	nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list, "ShotgunCase2",	nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list, "RifleCase1",		nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list, "RifleCase2",		nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list, "RifleCase3",		nil, true);
		...
		RemoveItemFromDistribution(ProceduralDistributions.list["PoliceStorageAmmunition"], "Bullets38Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["PoliceStorageAmmunition"], "Bullets45Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["PoliceStorageAmmunition"], "Bullets44Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["PoliceStorageAmmunition"], "223Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["PoliceStorageAmmunition"], "556Box", nil, true);
		...
		RemoveItemFromDistribution(ProceduralDistributions.list["ArmyStorageAmmunition"], "Bullets9mmBox", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["ArmyStorageAmmunition"], "Bullets38Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["ArmyStorageAmmunition"], "Bullets45Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["ArmyStorageAmmunition"], "Bullets44Box", nil, true);
		RemoveItemFromDistribution(ProceduralDistributions.list["ArmyStorageAmmunition"], "223Box", nil, true);
