...
ISLabelMod = ISUIElement:derive("ISLabelMod");
...
function ISLabelMod:initialise()
	ISUIElement.initialise(self);
end

function ISLabelMod:getName()
	return self.name;
end


function ISLabelMod:setName(name)
...
function ISLabelMod:setColor(r,g,b)
	self.r = r;
	self.g = g;
	self.b = b;
end
...
function ISLabelMod:onMouseMove(dx, dy)
    self.mouseOver = true;
end

function ISLabelMod:onMouseMoveOutside(dx, dy)
    self.mouseOver = false;
end

function ISLabelMod:updateTooltip()
...
function ISLabelMod:setTooltip(tooltip)
    self.tooltip = tooltip;
end

function ISLabelMod:setJoypadFocused(focused)
    self.joypadFocused = focused;
    self.joypadTexture = getTexture("media/ui/abutton.png");
end

function ISLabelMod:setTranslation(translation)
...
--**
--************************************************************************--
function ISLabelMod:new (x, y, width, height, name, r, g, b, a, font)
	local o = {}
	--o.data = {}
