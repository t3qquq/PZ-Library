...
local PlayInstrumentActionWorld = ISBaseTimedAction:derive('PlayInstrumentActionWorld');
...
function PlayInstrumentActionWorld:isValid()

   return true;
end


function PlayInstrumentActionWorld:waitToStart()
		return false
	end

function PlayInstrumentActionWorld:update()
...
function PlayInstrumentActionWorld:start()
...
function PlayInstrumentActionWorld:stop()
	...
	if self.character:getPrimaryHandItem() and self.character:getPrimaryHandItem():getFullType() and
	((self.character:getPrimaryHandItem():getFullType() == 'Base.GuitarElectricBassBlack') or
	(self.character:getPrimaryHandItem():getFullType() == 'Base.GuitarElectricBassBlue') or
	(self.character:getPrimaryHandItem():getFullType() == 'Base.GuitarElectricBassRed') or
	(self.character:getPrimaryHandItem():getFullType() == 'Base.GuitarElectricBlack') or
	(self.character:getPrimaryHandItem():getFullType() == 'Base.GuitarElectricBlue') or
...
function PlayInstrumentActionWorld:perform()
...
function PlayInstrumentActionWorld:new(character, equippedInstrument, sound, length, level, xp, boredomReduction, stressReduction, actionType)
    local o = {}
    setmetatable(o, self)
    self.__index = self
...
return PlayInstrumentActionWorld;
]]--