...
local function preDistributionMerge()
    ProceduralDistributions.list.CostumeStoreHatsAZ = {
        ...
        items = { --Hats
            ...
            "AuthenticZClothing.Hat_DeerSkull", 5,
            ...
            "AuthenticZClothing.Hat_PlagueDoctor_Mask", 5,			
            "AuthenticZClothing.Hat_RuneDuel", 5,
            "AuthenticZClothing.Hat_SamuraiHelmet", 5,
            "AuthenticZClothing.Hat_Spiffo_Happy_Cap", 5,
            ...
            "AuthenticZClothing.Hat_TopHat_AZ", 5,			
            "AuthenticZClothing.Hat_UncleSam", 5,
            "AuthenticZClothing.Hat_Unicorn_Head", 5,
            "AuthenticZClothing.Hat_VikingHelmet", 5,
            ...
            "AuthenticZClothing.Mask_Oni", 5,
            "AuthenticZClothing.Mask_Samurai", 5,			
        ...
        junk = { --Hats Junk
            ...
            "AuthenticZClothing.AuthenticBalloon_Foil", 1,			
            "AuthenticZClothing.AuthenticBalloon_Animal_Dog", 1,			
            }
        }
    }
    ...
    ProceduralDistributions.list.CostumeStoreClothingAZ = {
        ...
        items = { --Clothing	
            ...
            "AuthenticZClothing.Dress_BallroomDress_Simple", 1,
            "AuthenticZClothing.Dress_BallroomDress_Elegant", 1,
            "AuthenticZClothing.Dress_BallroomDress_LongSleevedButtonedApron", 1,
            "AuthenticZClothing.Dress_BallroomDress_LongSleevedButtoned", 1,
            "AuthenticZClothing.Dress_BallroomDress_Striped", 1,
            "AuthenticZClothing.Dress_BallroomDress_StripedApron", 1,
            "AuthenticZClothing.Dress_BallroomDress_Pattern", 1,	
            "AuthenticZClothing.Glasses_Popeyes", 1,			
            "AuthenticZClothing.Hat_PlagueDoctor_Mask", 5,
            "AuthenticZClothing.HawaiianLei", 1,
            "AuthenticZClothing.HoodieDOWN_BearHeaddress", 5,			
            "AuthenticZClothing.HoodieDOWN_Buzzers", 5,			
            "JacketLong_Doctor", 1,
            "JacketLong_Santa", 1,
            ...
            "Shirt_Jockey05", 5,
            "Shirt_Jockey06", 5,
            "AuthenticZClothing.Shirt_UndershirtFancy", 5,			
            "AuthenticZClothing.AlienBody", 1,			
            "AuthenticZClothing.SkeletonBody", 1,			
            "AuthenticZClothing.WendigoBody", 1,	
            ...
            "AuthenticZClothing.Tie_Full_TheMask", 3,			
            ...
            "AuthenticZClothing.Vest_SamuraiBreastPlate", 5,
        ...
        junk = { --CostumeStoreClothingA Junk
            rolls = 1,
            items = {
            "AuthenticZClothing.AuthenticBalloon_Purple", 1,    
            "AuthenticZClothing.AuthenticBalloon_Red", 1,    
...
--"Weapons"	
            ...
            "AuthenticZClothing.AuthenticPoolNoodle", 5,
            "AuthenticZClothing.Samurai_ZokBanner", 5,			
            "AuthenticZClothing.Samurai_WarBanner", 5,			
...
--Misc	
            ...
            "AuthenticZClothing.Authentic_Headphones3", 8,
            "AuthenticZClothing.Authentic_Headphones4", 8,
            "AuthenticZClothing.CigarAZ", 8,
            "AuthenticZClothing.Gloves_FreddyKreuger", 5,
            "AuthenticZClothing.Gloves_LeatherGauntlets", 5,
            "AuthenticZClothing.Gloves_SamaraiArmor_Gauntlets", 5,
            ...
            "AuthenticZClothing.Glasses_Popeyes", 1,
            "AuthenticZClothing.Necklace_NeckProtector", 5,			
            "AuthenticZClothing.AuthenticPoolNoodle", 5,			
            ...
            "AuthenticZClothing.SpiffoCherry", 1,
            ...
            "AuthenticZClothing.SubstitutionDoll", 1,			
            "SpiffoTail", 1,
            "Hairgel", 1,
            "AuthenticZClothing.ToyBear", 1,
            "AuthenticZClothing.ToyBearSmall", 1,
            "AuthenticZClothing.Doll", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Blue", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Cyan", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Orange", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Green", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Pink", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Purple", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Red", 1,
            "AuthenticZClothing.AuthenticAquaBottle_Yellow", 1,
            "AuthenticZClothing.AuthenticGymBottle_Blue", 1,
            "AuthenticZClothing.AuthenticGymBottle_Camo", 1,
            "AuthenticZClothing.AuthenticGymBottle_CamoUrban", 1,
            "AuthenticZClothing.AuthenticGymBottle_Gradient1", 1,
            "AuthenticZClothing.AuthenticGymBottle_Green", 1,
            "AuthenticZClothing.AuthenticGymBottle_Pink", 1,
            "AuthenticZClothing.AuthenticGymBottle_Purple", 1,
            "AuthenticZClothing.AuthenticGymBottle_Red", 1,
            "AuthenticZClothing.AuthenticGymBottle_Transparent", 1,
            "AuthenticZClothing.AuthenticGymBottle_US", 1,
            "AuthenticZClothing.AuthenticGymBottle_Yellow", 1,			
            "AuthenticZClothing.AuthenticGlowstick_Pack", 5,			
--Backpacks					
            "AuthenticZClothing.Bag_ProtonPack_Back", 5,
            "AuthenticZClothing.Bag_L4DeadMedkit", 5,
            "AuthenticZClothing.Bag_ALICEpack_Festive", 5,
            "AuthenticZClothing.Bag_DuffelBag_Festive", 5,		
            "AuthenticZClothing.Bag_Packsport_Plain", 5,			
            "AuthenticZClothing.Bag_Packsport_Rim", 5,			
            "AuthenticZClothing.Bag_Schoolbag_Spiffo2", 5,				
--Skins		
        ...
        junk = {
            ...
            "AuthenticZClothing.Authentic_Headphones3", 3, 			
            "AuthenticZClothing.Authentic_Headphones4", 3, 			
            "AuthenticZClothing.AuthenticBalloon_Purple", 1,    
            "AuthenticZClothing.AuthenticBalloon_Red", 1,    
            "AuthenticZClothing.AuthenticBalloon_White", 1,    
            "AuthenticZClothing.AuthenticBalloon_Yellow", 1,
...
--Misc					
            ...
            "AuthenticZClothing.Authentic_Headphones3", 5,
            "AuthenticZClothing.Authentic_Headphones4", 5,
            "AuthenticZClothing.Gloves_FreddyKreuger", 5,
            "AuthenticZClothing.Gloves_LeatherGauntlets", 5,
            "AuthenticZClothing.Gloves_SamaraiArmor_Gauntlets", 5,
            ...
            "AuthenticZClothing.HairDyePurple", 5,
            "AuthenticZClothing.Glasses_Popeyes", 1,			
            "AuthenticZClothing.Leg_SamuraiShinGuards", 5,
            "AuthenticZClothing.Necklace_NeckProtector", 5,				
...
--Clothing					
            ...
            "AuthenticZClothing.Dress_BallroomDress_StripedApron", 1,
            "AuthenticZClothing.Dress_BallroomDress_Pattern", 1,
            "AuthenticZClothing.HoodieDOWN_BearHeaddress", 1,				
            "AuthenticZClothing.HoodieDOWN_Buzzers", 1,				
            "JacketLong_Doctor", 1,
            "JacketLong_Santa", 1,
            "JacketLong_SantaGreen", 1,
            "Jacket_Chef", 1,
