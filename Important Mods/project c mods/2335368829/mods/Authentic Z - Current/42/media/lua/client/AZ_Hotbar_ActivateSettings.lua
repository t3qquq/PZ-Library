...
local function AZHotbar_RegisterEasyConfig()
	if EasyConfig_Chucked and EasyConfig_Chucked.mods then
	EasyConfig_Chucked.mods[AZHotbar.modId] = AZHotbar
	end
end

AZHotbar_LoadSlotsToMenu()
AZHotbar_RegisterEasyConfig()

if Events and Events.OnGameStart then
	Events.OnGameStart.Add(AZHotbar_RegisterEasyConfig)
end
]]
