...
HApplyBandage = B41.BaseHandler:derive("HApplyBandage")
...
HRemoveBandage = B41.BaseHandler:derive("HRemoveBandage")
...
HApplyPoultice = B41.BaseHandler:derive("HApplyPoultice")
...
HDisinfect = B41.BaseHandler:derive("HDisinfect")
...
HStitch = B41.BaseHandler:derive("HStitch")
...
HRemoveStitch = B41.BaseHandler:derive("HRemoveStitch")
...
HRemoveGlass = B41.BaseHandler:derive("HRemoveGlass")
...
HSplint = B41.BaseHandler:derive("HSplint")
...
HRemoveSplint = B41.BaseHandler:derive("HRemoveSplint")
...
HRemoveBullet = B41.BaseHandler:derive("HRemoveBullet")
...
HCleanBurn = B41.BaseHandler:derive("HCleanBurn")
