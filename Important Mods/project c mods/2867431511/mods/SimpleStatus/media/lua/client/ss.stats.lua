...
stats.endurance.valueFn = function(player)
    return round(player:getStats():getEndurance() * 100)
end
-------------
-- Hunger --
-------------
...
stats.thirst.valueFn = function(player)
    return round((1 - player:getStats():getThirst()) * 100)
end
-------------
-- Fatigue --
-------------
...
stats.happy.valueFn = function(player)
    return round(100 - player:getBodyDamage():getUnhappynessLevel())
end
...
stats.boredom.valueFn = function(player)
    return round(player:getBodyDamage():getBoredomLevel())
end
----------------
--    Pain    --
----------------
...
stats.pain.valueFn = function(player)
    return round(player:getStats():getPain())
end
----------------
--    Panic   --
----------------
...
stats.panic.valueFn = function(player)
    return round(player:getStats():getPanic())
end
----------------
--    Stress  --
----------------
...
stats.stress.valueFn = function(player)
    return round(player:getStats():getStress() * 100)
end
----------------
--  Sickness  --
----------------
...
stats.sickness.valueFn = function(player)
    return round(player:getStats():getSickness() * 100)
end
----------------
--    Anger   --
----------------
...
stats.anger.valueFn = function(player)
    return round(player:getStats():getAnger() * 100)
end
----------------
--    Sanity  --
----------------
