Events.OnGameStart.Add(function()
	...
	local upperLayer = {}
	upperLayer.SearchGridAction = {}
	-------------------------------------------------------------------------------------------------------------------------------------------------------
	upperLayer.SearchGridAction.startActionAnim = SearchGridAction.startActionAnim
	function SearchGridAction:startActionAnim()
	    upperLayer.SearchGridAction.startActionAnim(self)
	    if self.sound then
	...
	-------------------------------------------------------------------------------------------------------------------------------------------------------
	upperLayer.SearchGridAction.update = SearchGridAction.update
	function SearchGridAction:update()
	    upperLayer.SearchGridAction.update(self)
