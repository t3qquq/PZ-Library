Events.OnGameStart.Add(function()
	if not getActivatedMods():contains("ImmersiveLooting_SearchMode") then return end
	require "TimedActions/SearchingAction"
	
	local upperLayer = {}
	upperLayer.SearchingAction = {}
	-------------------------------------------------------------------------------------------------------------------------------------------------------
	--upperLayer.SearchingAction.start = SearchingAction.start
	function SearchingAction:start()
	    --upperLayer.SearchingAction.start(self)
	    if self.sound then
	...
	-------------------------------------------------------------------------------------------------------------------------------------------------------
	upperLayer.SearchingAction.update = SearchingAction.update
	function SearchingAction:update()
	    ...
	    upperLayer.SearchingAction.update(self)
	end
end)
